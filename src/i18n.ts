...
const en = {
  ...
  settingsThemePresetHelp: "Switches the whole color palette. Presets are independent of the accent color, density and syntax colors. High contrast and Colorblind-safe follow the light/dark toggle; dark-only presets ignore it.",
...
const ja: Dict = {
  ...
  settingsThemePresetHelp: "カラーパレット全体を切り替えます。プリセットはアクセント色・密度・シンタックス配色とは独立しています。高コントラスト・色覚多様性対応はライト/ダークの切替に追従し、ダーク専用プリセットは切替を無視します。",
