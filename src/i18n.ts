...
const en = {
  ...
  sizeDesc:
    "Per-table size and row statistics for {database}, read from the engine's catalogs (no table scan). Click a column header to sort.",
  sizeRefresh: "Refresh",
  sizeColName: "Table",
...
const ja: Dict = {
  ...
  sizeDesc:
    "{database} のテーブルごとのサイズと行数統計です。エンジンのカタログから取得するためテーブルスキャンは発生しません。列見出しをクリックでソートします。",
  sizeRefresh: "更新",
  sizeColName: "テーブル",
  sizeColRows: "行数 (概算)",
  sizeColData: "データ",
