...
const en = {
  ...
  flightRecorderClear: "Clear captures",
  flightRecorderClearConfirmProfile: "Delete all captured writes for this connection? Undo will no longer be available for them.",
  flightRecorderClearConfirmAll: "Delete ALL captured writes for every connection? Undo will no longer be available for them.",
  flightRecorderCleared: "Deleted {count} captured write(s).",
  ...
  taskHistoryClearConfirm: "Delete this task's run history? The task itself and its schedule are kept.",
  taskHistoryCleared: "Deleted {count} run(s).",
...
const ja: Dict = {
  ...
  flightRecorderClear: "記録をクリア",
  flightRecorderClearConfirmProfile: "この接続の記録済み書き込みをすべて削除しますか？ 以後それらの巻き戻しはできなくなります。",
  flightRecorderClearConfirmAll: "すべての接続の記録済み書き込みを削除しますか？ 以後それらの巻き戻しはできなくなります。",
  flightRecorderCleared: "記録を {count} 件削除しました。",
  ...
  taskHistoryClear: "実行履歴をクリア",
  taskHistoryClearConfirm: "このタスクの実行履歴を削除しますか？ タスク自体とスケジュールは残ります。",
  taskHistoryCleared: "実行履歴を {count} 件削除しました。",
