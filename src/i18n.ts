...
const en = {
  ...
  settingsAccentColorHelp: "Color used for buttons, links, focus rings, and interactive elements throughout the app. All presets meet WCAG AA contrast requirements.",
  settingsAccentPresetBlue: "Blue",
  settingsAccentPresetIndigo: "Indigo",
  settingsAccentPresetViolet: "Violet",
  settingsAccentPresetRose: "Rose",
  settingsAccentPresetEmerald: "Emerald",
  settingsAccentPresetAmber: "Amber",
  settingsAccentPresetTeal: "Teal",
  settingsAccentPresetCustom: "Custom",
  settingsAccentCustomLabel: "Custom color ({theme} theme)",
  settingsAccentCustomHelp: "Pick a custom accent color for the {theme} theme. Text color is adjusted automatically to maintain contrast.",
...
const ja: Dict = {
  ...
  settingsAccentColorHelp: "ボタン・リンク・フォーカスリング・インタラクティブ要素に使われる色です。すべてのプリセットは WCAG AA コントラスト基準を満たしています。",
  settingsAccentPresetBlue: "ブルー",
  settingsAccentPresetIndigo: "インディゴ",
  settingsAccentPresetViolet: "バイオレット",
  settingsAccentPresetRose: "ローズ",
  settingsAccentPresetEmerald: "エメラルド",
  settingsAccentPresetAmber: "アンバー",
  settingsAccentPresetTeal: "ティール",
  settingsAccentPresetCustom: "カスタム",
  settingsAccentCustomLabel: "カスタムカラー ({theme}テーマ)",
  settingsAccentCustomHelp: "{theme}テーマのアクセントカラーを自由に選択できます。コントラストを確保するため前景色は自動的に調整されます。",
