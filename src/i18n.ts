...
const en = {
  ...
  activityCenterTitle: "Activity",
  activityOpen: "Activity — recent notifications",
  activityOpenUnread: "Activity — {count} unread notifications",
  activityClose: "Close activity",
  activityClear: "Clear",
  activityEmpty: "No notifications yet. Toasts shown while you work are kept here.",
  activityNoMatches: "No notifications match this filter.",
  activityFilterAll: "All",
  activityFilterAria: "Filter by severity",
  activityListAria: "Recent notifications",
  activitySeverityInfo: "Info",
  activitySeveritySuccess: "Success",
  activitySeverityWarning: "Warning",
  activitySeverityError: "Error",
  activityTimeNow: "just now",
  activityTimeMinutes: "{n} min ago",
  activityTimeHours: "{n} h ago",
  activityTimeDays: "{n} d ago",
  activityFooterNote: "Latest {limit} notifications from this session (not saved on exit).",
  activityOpenInPanel: "Open in panel",
  activityEmptyTitle: "No activity yet",
  messagesTitle: "Messages",
  messagesEmptyTitle: "No messages yet",
  messagesEmpty: "Status bar messages (connections, query results, errors) are kept here so you can read them after the next action replaces them.",
  messagesListAria: "Status message history",
  messagesRepeat: "×{count}",
  outputTitle: "Output",
  outputEmptyTitle: "Nothing has run yet",
  outputEmpty: "Each statement you run is listed here with its row count, duration and any error.",
  outputListAria: "Executed statements",
  outputFilterAria: "Filter executed statements",
  outputFilterProblems: "Problems",
  outputSummaryRows: "{rows} rows · {ms} ms",
  outputSummaryAffected: "{rows} rows affected · {ms} ms",
  ...
  outputCopied: "SQL copied",
  cmdkOutput: "Show output (executed statements)",
  cmdkMessages: "Show messages (status history)",
  cmdkActivityPanel: "Show activity in the bottom panel",
  statusOpenMessages: "Show message history",
  shortcutModalSubmitTitle: "Cmd/Ctrl+Enter / Esc",
  shortcutModalSubmitDesc: "In a dialog or form: run the primary action (Esc closes without running).",
  ...
  healthRefresh: "Check now",
  healthIncludeSaved: "Show saved profiles",
  healthColName: "Connection",
  healthColStatus: "Status",
  healthColLatency: "Latency",
  healthColVersion: "Version",
  healthColConnections: "Sessions",
  healthColActions: "Actions",
  healthStatusUp: "Up",
  healthStatusDown: "Down",
  healthStatusTimeout: "Timed out",
  healthStatusUnknown: "Checking…",
  healthStatusNotConnected: "Not connected",
  healthNa: "N/A",
  healthNaHint: "No server (file-backed database)",
  healthLatencyMs: "{ms} ms",
  healthActive: "Active",
  healthReadOnly: "Read-only",
  healthSwitch: "Switch",
  healthConnect: "Connect",
  healthReconnect: "Reconnect",
  healthReconnected: "Reconnected {name}",
  healthReconnectFailed: "Could not reconnect {name}",
  healthSummary: "{up} of {open} up",
  healthSummaryDown: "{count} down",
  healthSummaryTimeout: "{count} timed out",
  healthSummaryLatency: "median {median} ms · max {max} ms",
  healthEmpty: "No open connections",
  healthUpdatedAt: "Updated {time}",
  healthTableAria: "Health of each connection",
  ...
  historyNoMatches: "No history matches the current filters.",
  ...
  historySaveAsSnippet: "Save as snippet",
  historyStatusError: "ERROR",
  historyRowsMeta: "{rows} rows",
  historyAffectedMeta: "{rows} affected",
  historyStatusFilterLabel: "Filter by status",
  historyStatusFilterAll: "All",
  historyStatusFilterOk: "Success only",
  historyStatusFilterError: "Errors only",
  historyPeriodFilterLabel: "Filter by period",
  historyPeriodFilterAll: "All time",
  historyPeriodFilterToday: "Today",
  historyPeriodFilterWeek: "Last 7 days",
  ...
  snippetMenuWatchPlan: "Watch execution plan",
  snippetMenuUnwatchPlan: "Stop watching execution plan",
  snippetWatchBadge: "Execution plan is watched",
  snippetOpenPlanWatch: "Execution plan watch",
  planWatchTitle: "Execution plan watch — {name}",
  planWatchClose: "Close",
  planWatchEmptyTitle: "No watched snippets",
  planWatchEmpty: "Right-click a snippet and choose \"Watch execution plan\" to record EXPLAIN plan generations and detect regressions.",
  planWatchSnippetMissing: "(deleted snippet)",
  planWatchGenerationCount: "{count} generations",
  planWatchNoGenerations: "No plan captured yet. Refresh while connected to record the first generation.",
  planWatchCompareFrom: "From",
  planWatchCompareTo: "To",
  planWatchLatestOption: "{time} (latest)",
  planWatchPaneFrom: "From (older)",
  planWatchPaneTo: "To (newer)",
  planWatchNoChanges: "No structural changes between the selected generations.",
  planWatchChangeAccess: "{object}: access method changed {before} → {after}",
  planWatchChangeIndex: "{object}: index changed {before} → {after}",
  planWatchChangeJoin: "{object}: join method changed {before} → {after}",
  planWatchChangeRows: "{object}: estimated rows changed {before} → {after}",
  planWatchChangeAdded: "{object}: operation added ({after})",
  planWatchChangeRemoved: "{object}: operation removed ({before})",
  planWatchUnwatch: "Stop watching",
  planWatchUnwatchHint: "Remove this snippet from the plan watch and delete its stored generations.",
  planWatchRefresh: "Refresh plans",
  planWatchRefreshing: "Refreshing...",
  planWatchRefreshHint: "Run EXPLAIN for every watched snippet and record a new generation when the plan changed.",
  planWatchNeedConnection: "Connect to this profile to refresh plans.",
  planWatchLocalOnlyNote: "Plans are stored locally only. EXPLAIN runs are read-only and never recorded to query history.",
  planWatchChangedToast: "Execution plan changed for {count} watched snippet(s)",
  planWatchRefreshFailedToast: "Plan check failed for {name}: {error}",

  schemaDriftTitle: "Schema drift timeline — {name}",
  schemaDriftClose: "Close",
  schemaDriftEmptyTitle: "No snapshots yet",
  schemaDriftEmpty: "Connect to this profile to record the first schema snapshot (enable \"Snapshot schema on connect\" in Settings if it's off).",
  schemaDriftGenerationTables: "{count} tables",
  schemaDriftLatestSuffix: "(latest)",
  schemaDriftOmittedBadge: "too large to store in full",
  schemaDriftCompareFrom: "From",
  schemaDriftCompareTo: "To",
  schemaDriftLatestOption: "{time} (latest)",
  ...
  schemaDriftColAdded: "{count} column(s) added",
  schemaDriftColRemoved: "{count} column(s) removed",
  schemaDriftColChanged: "{count} column(s) changed",
  schemaDriftIdxAdded: "{count} index(es) added",
  schemaDriftIdxRemoved: "{count} index(es) removed",
  schemaDriftIdxChanged: "{count} index(es) changed",
  schemaDriftCaptureNow: "Capture snapshot now",
  schemaDriftCapturing: "Capturing...",
  schemaDriftCaptureHint: "Capture a schema snapshot for this connection's default database right now.",
  schemaDriftNeedConnection: "Connect to this profile to capture a snapshot.",
  schemaDriftLocalOnlyNote: "Snapshots are stored locally only. Capturing them is read-only and never recorded to query history.",
  schemaDriftChangedToast: "Schema changed since the last connection — {detail}",
  schemaDriftRefreshFailedToast: "Schema drift check failed: {error}",
  ...
  settingsSyntaxPresetNord: "Nord",
  settingsSyntaxPresetOneDark: "One Dark",
  ...
  settingsShortcutsHelp:
    "Reassign keys for the main actions. Conflicts within the same scope are flagged. Changes apply immediately and are reflected in the cheat sheet (?) and help.",
  settingsShortcutsResetAll: "Reset all",
  settingsShortcutRecord: "Change",
  settingsShortcutRecording: "Press keys… (Esc to cancel)",
  settingsShortcutConflict: "Conflict",
  ...
  flightRecorderClearAction: "Clear all",
  flightRecorderClearConfirmProfile: "Delete all captured writes for this connection? This cannot be undone.",
  flightRecorderClearConfirmAll: "Delete ALL captured writes for every connection? This cannot be undone.",
  ...
  settingsSchemaDriftOnConnect: "Snapshot schema on connect",
  settingsSchemaDriftOnConnectHelp: "When connecting, capture a schema snapshot for the profile's default database and notify if it differs from the previous snapshot. Read-only and never written to query history. Turn off to only browse the stored timeline.",
  ...
  shortcutRunStatementTitle: "Cmd/Ctrl+Alt+Enter",
  shortcutRunStatementDesc:
    "Run only the single statement under the cursor (selection takes priority when present).",
  ...
  themePresetSolarized: "Solarized",
  themePresetOneDark: "One Dark",
  themePresetHighContrast: "High contrast",
  themePresetColorblind: "Colorblind-safe",
  settingsMotionPreference: "Motion",
  settingsMotionPreferenceHelp: "Controls how much animation the app shows. \"Follow system\" respects the OS's reduce-motion setting; \"Full\" and \"Reduced\" override the OS setting either way.",
  settingsMotionPreferenceSystem: "Follow system",
  settingsMotionPreferenceFull: "Full",
  settingsMotionPreferenceReduced: "Reduced",
  themePreviewChipBg: "Background",
  themePreviewChipSurface: "Surface",
  themePreviewChipAccent: "Accent",
  themePreviewChipText: "Text",
  themePreviewChipKeyword: "Keyword",
  ...
  contextMenuDisconnect: "Disconnect",
  toastDisconnected: "Disconnected from {name}",
  toastSwitchedConnection: "Switched to {name}",
  listProduction: "PROD",
  ...
  statusReconnectingAttempt: "Connection lost — reconnecting to {name}... (attempt {attempt}/{max})",
  statusReconnected: "Reconnected to {name}.",
  statusReconnectGaveUp: "Couldn't reconnect to {name} after {max} attempts. The session was closed — please reconnect manually.",
  statusReconnectBusy: "Reconnecting — the query will run once the connection is restored.",
  statusReconnectTx: "The connection dropped during a transaction. To avoid a partial commit it was not auto-reconnected — please reconnect and re-run the transaction.",
  ...
  formInitSqlPlaceholderDuckDb: "SET memory_limit = '4GB';\nSET threads = 4;",
  formInitSqlHelp:
  ...
  formDriverDuckDb: "DuckDB",
  formDriverMssql: "Microsoft SQL Server",
  formMysqlLegend: "MySQL",
  formPostgresLegend: "PostgreSQL",
  formSqliteLegend: "SQLite",
  formMssqlLegend: "Microsoft SQL Server",
  ...
  formDuckDbLegend: "DuckDB",
  formDuckDbFilePath: "Database file",
  formDuckDbFilePathPlaceholder: "/path/to/database.duckdb",
  formDuckDbFilePathHelp: "Absolute path to a DuckDB database file. The file must already exist.",
  formHost: "Host",
  formPort: "Port",
  formUser: "User",
  ...
  // ツールバーのオーバーフローメニュー (#915)。
  editorMoreActions: "More actions",
  editorMoreActionsTitle: "Explain, snippets, files, broadcast and the query builder.",
  ...
  explainViewTree: "Tree",
  explainViewGraph: "Diagram",
  ...
  qbBoolNull: "NULL",
  qbSetNow: "Set to now",
  qbNotNullWarning: "This column is NOT NULL — NULL will fail when the statement runs.",
  qbLimitInvalid: "LIMIT must be a whole number — the clause will be omitted.",
  qbNoWhereBand: "No WHERE clause — every row in the table will be affected.",
  qbValidationNoTable: "Select a table first.",
  qbValidationNoInsertValues: "Fill in at least one column and value to insert.",
  ...
  editApplyConfirmTitle: "Apply changes to a production connection?",
  editApplyConfirmBody: "You are about to apply {count} change(s) to a production database. Continue?",
  ...
  // 調査バンドル (#745)。
  exportFormatBundle: "Investigation bundle (HTML)",
  exportBundleOptions: "Bundle contents",
  exportBundleDataWarning:
    "This self-contained HTML file will contain {rows} rows × {cols} columns of real data. Check who you share it with.",
  exportBundleMasked: "{count} sensitive column(s) are written as •••• (column mask): {names}",
  exportBundleNoMasked: "No column matches the sensitive-column mask; values are written as-is.",
  exportBundleNoSecrets: "Passwords and connection strings are never included.",
  exportBundleIncludeHost: "Include the host name",
  exportBundleIncludeSchema: "Include table definitions",
  exportBundleIncludePlan: "Include the execution plan (runs EXPLAIN)",
  bundleTitle: "noobDB investigation bundle",
  bundleNotice: "Generated by noobDB at {at}. The data is a snapshot as of that time.",
  bundleSectionMeta: "Context",
  bundleSectionSql: "Query",
  bundleSectionResult: "Result",
  bundleSectionSchema: "Table definitions",
  bundleSectionPlan: "Execution plan",
  bundleGeneratedAt: "Generated at",
  bundleExecutedAt: "Executed at",
  bundleProfile: "Connection",
  bundleDriver: "Driver",
  bundleDatabase: "Database",
  bundleHost: "Host",
  bundleRows: "Rows × columns",
  bundleElapsed: "Execution time",
  bundlePartial: "Only the rows loaded in the grid are included — the full result set may be larger.",
  bundleMasked: "masked",
  bundleSortHint: "Click a column header to sort.",
  bundleNoSql: "(no query recorded)",
  bundleNoRows: "(no rows)",
  bundleUnavailable: "Could not be retrieved",
  bundleColName: "Column",
  bundleColType: "Type",
  bundleColNullable: "Nullable",
  bundleColKey: "Key",
  bundleColDefault: "Default",
  ...
  exportSqlHint:
    "Generates INSERT statements with driver-specific literal escaping, grouping rows into batches.",
  imageExportButton: "Export image",
  imageExportPng: "Save as PNG",
  imageExportSvg: "Save as SVG",
  imageExportCopy: "Copy PNG to clipboard",
  imageExportSaved: "Saved image to {path}",
  imageExportCopied: "Copied image to clipboard",
  imageExportCopyFailed: "Couldn't copy the image to the clipboard",
  imageExportError: "Image export failed: {error}",
  ...
  // エクスポート時のデータマスキング (#733)。
  exportMasking: "Data masking",
  exportMaskingEnable: "Mask PII columns in the output",
  exportMaskingHint: "Only the written file is transformed — the database is never modified. Columns whose name matches a saved preset are masked automatically.",
  exportMaskingHashNote: "Pseudonymization uses HMAC-SHA256 keyed by an app-wide secret salt stored only in the OS keyring, so the same value always becomes the same pseudonym (usable as a join key).",
  exportMaskingRuleFor: "Masking rule for {column}",
  exportMaskingFixedValueFor: "Replacement value for {column}",
  exportMaskingKeepStartFor: "Characters to keep at the start of {column}",
  exportMaskingKeepEndFor: "Characters to keep at the end of {column}",
  exportMaskingHashLengthFor: "Pseudonym length for {column}",
  exportMaskingKeepStart: "First",
  exportMaskingKeepEnd: "Last",
  exportMaskingHashLength: "Length",
  exportMaskRuleNone: "No masking",
  exportMaskRuleFixed: "Fixed value",
  exportMaskRulePartial: "Partial mask",
  exportMaskRuleHash: "Pseudonymize (hash)",
  exportMaskRuleNull: "Set to NULL",
  exportMaskingFromPreset: "preset",
  exportMaskingSavePreset: "Save as the preset for this column name",
  exportMaskingPresetSaved: "Saved \"{column}\" as a masking preset",
  exportMaskingNoColumns: "No columns will be masked.",
  exportMaskedColumns: "{count} column(s) masked",
  exportMaskingPending: "Applying masking…",
  exportMaskingError: "Could not apply masking: {error}",
  exportMaskedSuffix: " ({count} column(s) masked)",
  ...
  chartAggNone: "None",
  // 配色 (#916): グリッドの条件付き書式と同じ共有カラースケールから選ぶ。
  chartPalette: "Colors",
  chartPalette_categorical: "Categorical",
  chartPalette_blue: "Blue",
  chartPalette_teal: "Teal",
  chartPalette_coolWarm: "Cool → warm",
  chartPalette_blueOrange: "Blue → orange",
  chartPaletteValueColoring: "Colored by value (light = low, dark = high)",
  ...
  pivotShow: "Pivot",
  pivotRowField: "Rows",
  pivotColField: "Columns",
  pivotValueField: "Value",
  pivotAgg: "Aggregate",
  pivotAgg_sum: "Sum",
  pivotAgg_avg: "Avg",
  pivotAgg_count: "Count",
  pivotAgg_min: "Min",
  pivotAgg_max: "Max",
  pivotNone: "(none)",
  ...
  pivotTotal: "Total",
  pivotInMemoryNote:
    "Aggregated over the {count} fetched rows (in memory). Send the GROUP BY SQL to the editor to re-aggregate the full source query on the server.",
  pivotSendSql: "Send GROUP BY SQL",
  pivotTruncated:
  ...
  // 現在のクエリをビューとして保存 / ビュー定義を編集して置換 (#851)。
  saveAsViewButton: "Save as view",
  saveAsViewButtonTitle: "Save the current result as a view (CREATE VIEW ... AS)",
  saveAsViewDisabledTitle:
    "Only a single SELECT/WITH query on a writable connection can be saved as a view.",
  saveAsViewTitle: "Save results as view",
  saveAsViewClose: "Close",
  saveAsViewNameLabel: "View name",
  saveAsViewNamePlaceholder: "new_view",
  saveAsViewNameReplaceNote: "A view named \"{view}\" already exists and will be replaced.",
  saveAsViewListError: "Couldn't verify existing view names: {error}",
  saveAsViewPreview: "SQL preview",
  saveAsViewPreviewEmpty: "Enter a view name to preview the SQL.",
  saveAsViewConfirm: "Create view",
  saveAsViewReplaceConfirm: "Replace view",
  saveAsViewSuccess: "Created view \"{view}\" from the result set.",
  saveAsViewReplaceSuccess: "Replaced view \"{view}\".",
  contextMenuEditViewDefinition: "Edit definition...",
  contextMenuDropView: "Drop view...",
  dropViewConfirmTitle: "Drop {view}?",
  dropViewConfirmBody: "This permanently removes the view {view}. This cannot be undone.",
  dropViewConfirmOk: "Drop view",
  ...
  dumpNoteNative: "Generates the SQL dump (schema DDL + INSERT statements) directly from this connection. No external client tools are needed.",
  ...
  // DB 全体からの値検索 (#748): 「この値はどのテーブル・どの列にあるか」を横断検索。
  cmdkActionDataSearch: "Search data values",
  dataSearchTitle: "Search data — {database}",
  dataSearchClose: "Close",
  dataSearchNote:
    "Scans the tables below one at a time, looking for the value in every text/number column. Read-only (SELECT only) — safe on read-only sessions.",
  dataSearchLoadingMeta: "Loading tables...",
  dataSearchTermLabel: "Value to search for",
  dataSearchTermPlaceholder: "Value...",
  dataSearchMatchModeLabel: "Match",
  dataSearchMatchExact: "Exact match",
  dataSearchMatchContains: "Contains",
  dataSearchMatchPrefix: "Starts with",
  dataSearchScopeLabel: "Scope",
  dataSearchScopeAll: "All tables",
  dataSearchScopeSelected: "Selected tables",
  dataSearchFilterPlaceholder: "Filter tables...",
  dataSearchNoFilterMatch: "No tables match the filter",
  dataSearchSelectedCount: "{selected} of {total} tables selected",
  dataSearchNoSelection: "Select at least one table",
  dataSearchThresholdLabel: "Skip tables larger than (estimated rows)",
  dataSearchThresholdHint: "Tables with more estimated rows than this are skipped and listed separately.",
  dataSearchEstimateRows: "~{rows} rows",
  dataSearchEstimateUnknownRows: "~{rows}+ rows (some tables' row counts are unknown)",
  dataSearchSummary: "{count} tables to scan ({rows})",
  dataSearchStart: "Start scan",
  dataSearchRunning: "Scanning...",
  dataSearchCancel: "Cancel",
  dataSearchConfirmTitle: "Scan {count} tables?",
  dataSearchConfirmBody:
    "This runs a read-only query against {count} tables ({rows} total) to look for the value. It may take a while on large databases.",
  dataSearchProductionConfirm: '"{name}" is a production connection — scanning many tables adds read load to the server. Continue?',
  dataSearchProgress: "Scanning {index}/{total} — {table}",
  dataSearchDone: "Done: {hits} tables with hits, {noHits} with no match, {skipped} skipped",
  dataSearchNoHits: "No matches found in the scanned tables.",
  dataSearchHitsHeading: "Matches",
  dataSearchHitCount: "{count} hits",
  dataSearchOpenTable: "Open all matches",
  dataSearchSkippedHeading: "Skipped tables",
  dataSearchSkipReasonThreshold: "Estimated row count exceeds the threshold",
  dataSearchSkipReasonNoColumns: "No searchable columns (text/number)",
  dataSearchSkipReasonError: "Error: {error}",
  dataSearchNewSearch: "New search",
  ...
  // `.sql` script runner (#973).
  contextMenuRunScript: "Run SQL file...",
  scriptTitle: "Run SQL file",
  scriptTitleDb: "Run SQL file on \"{database}\"",
  scriptNote:
    "Runs a .sql file statement by statement without loading it all into memory (e.g. restoring a dump). Read-only profiles still reject every write statement.",
  scriptFileLabel: "SQL file",
  scriptFilePlaceholder: "/path/to/script.sql",
  scriptBrowse: "Browse…",
  scriptPickFileTitle: "Choose a SQL file to run",
  scriptOptionsLabel: "On error",
  scriptOptContinue: "Continue on error",
  scriptOptContinueHint:
    "Skip statements that fail and keep going; the failed statements are listed at the end. Each statement is committed as it runs.",
  scriptOptWrap: "Wrap in a transaction (all-or-nothing)",
  scriptOptWrapHint:
    "Run the whole file in one transaction and roll everything back on the first error or on cancel. BEGIN/COMMIT inside the file are skipped. On MySQL/MariaDB, DDL (CREATE/ALTER/DROP…) commits implicitly, so a script with DDL is not atomic there.",
  scriptSessionNote:
    "Without a transaction each statement may run on a different pooled connection, so session settings (SET …) only carry over inside a transaction.",
  scriptExecute: "Run",
  scriptRunning: "Running…",
  scriptCancelRun: "Cancel",
  scriptClose: "Close",
  scriptProgress: "{executed} statements executed",
  scriptProgressFailed: "{failed} failed",
  scriptProgressPercent: "{percent}% of file read",
  scriptDone: "Ran {executed} statements in {secs}s ({rows} rows affected).",
  scriptDonePartial: "Ran {executed} statements: {failed} failed and were skipped.",
  scriptDoneSkippedControl: "{count} BEGIN/COMMIT statements in the file were skipped (the runner's transaction was used).",
  scriptFailuresLabel: "Failed statements",
  scriptFailuresOmitted: "…and {count} more",
  scriptFailureLine: "line {line}",
  scriptError: "Script stopped: {error}",
  scriptErrorAt: "Stopped at line {line}: {error}",
  scriptRolledBack: "The open transaction was rolled back.",
  scriptCancelled: "Script cancelled. {count} committed statements were kept.",
  scriptProductionConfirmTitle: "Run on a production connection?",
  scriptProductionConfirmMessage: "This connection is marked as production. Run \"{file}\" against it?",
  scriptProductionConfirmOk: "Run",
  // Cross-connection data transfer (#986).
  transferTitle: "Copy to another connection",
  transferClose: "Close",
  transferNote:
    "Copies the table or result set into a table on another connection, schema and data included. Rows are streamed in batches; constraints and indexes are not copied.",
  transferSourceLabel: "Source",
  transferSourceTable: "Table {table} (all rows)",
  transferSourceQuery: "Result of the current query (re-run in full)",
  transferTargetProfile: "Target connection",
  transferSelectProfile: "Select a connection…",
  transferConnectError: "Could not connect: {error}",
  transferTargetReadOnly: "This connection is read-only; data cannot be transferred into it.",
  transferTargetDatabase: "Target database / schema",
  transferTargetTable: "Target table",
  transferTableExists: "Table {table} already exists. Choose “Replace” or “Append”.",
  transferTableMissing: "Table {table} does not exist, so rows cannot be appended.",
  transferSameTable: "The source and target are the same table.",
  transferModeLabel: "If the table exists",
  transferModeCreate: "Create a new table (fail if it exists)",
  transferModeReplace: "Replace (drop and recreate)",
  transferModeAppend: "Append to the existing table",
  transferModeCreateHint:
    "Column types are mapped to the target database. If the transfer fails or is cancelled, the partially created table is dropped.",
  transferModeAppendHint:
    "Columns are matched by name. Rows written before a failure or cancel remain in the table.",
  transferProgress: "Transferring… {rows} rows written",
  transferError: "Transfer failed: {error}",
  transferCancelRun: "Cancel transfer",
  transferRunning: "Transferring…",
  transferExecute: "Transfer",
  transferReplaceConfirmTitle: "Replace the existing table?",
  transferReplaceConfirmBody:
    "Table {table} on {name} will be dropped and recreated from the source. Its current data will be lost.",
  transferReplaceConfirmOk: "Drop and replace",
  transferProductionReplaceBody:
    "{name} is a production connection. Table {table} will be dropped and recreated — its current data will be lost. Type the connection name to confirm.",
  transferProductionConfirm: "{name} is a production connection. Write the transferred rows into {table}?",
  transferDone: "Transferred {rows} rows into {table} on {name}.",
  transferCancelled: "Transfer cancelled. The partially created table was dropped.",
  transferCancelledAppend: "Transfer cancelled. {rows} rows had already been appended.",
  transferResultButton: "Copy to…",
  transferResultButtonTitle: "Copy this query's full result into a table on another connection",
  contextMenuTransferTable: "Copy to another connection...",
  ...
  // 列編集ダイアログ (ALTER TABLE ADD/MODIFY/DROP/RENAME COLUMN・CREATE INDEX、#794)。
  alterTableTitle: "Edit columns: {table}",
  alterTableLoading: "Loading columns...",
  alterTableLoadError: "Failed to load columns: {error}",
  alterTableExistingSection: "Existing columns",
  alterTableMysqlExtraNote:
    "Renaming or changing a column's type/NOT NULL/DEFAULT preserves AUTO_INCREMENT and ON UPDATE, but not character set/collation, COMMENT, or generated-column expressions (this dialog doesn't read those).",
  alterTableNewName: "New name",
  alterTableDrop: "Drop",
  alterTableKeep: "Keep",
  alterTableNotNullAria: "NOT NULL for {column}",
  alterTableNotNullNewAria: "NOT NULL for new column {n}",
  alterTableAddedSection: "New columns",
  alterTableIndexNamePlaceholder: "index_name",
  alterTableAddIndex: "Add index",
  alterTableRemoveIndex: "Remove index",
  alterTableUnsupportedTitle: "Not supported on this driver",
  alterTableUnsupportedSqlite:
    "{column}: SQLite cannot change a column's type, NOT NULL or DEFAULT in place. Recreate the table to migrate the data.",
  alterTablePreview: "SQL preview",
  alterTablePreviewEmpty: "No changes yet.",
  alterTableRun: "Apply",
  alterTableReadOnly: "This connection is read-only; editing columns is disabled.",
  alterTableConfirmTitle: "Apply these changes to {table}?",
  alterTableConfirmBody: "The following statements will run:",
  alterTableConfirmOk: "Apply",
  alterTableSuccess: "Updated the columns of {table}.",
  // インデックス作成の軽量モーダル (#850)。
  createIndexTitle: "Create index: {table}",
  createIndexName: "Index name",
  createIndexNamePlaceholder: "(auto-generated if empty)",
  createIndexColumns: "Columns",
  createIndexPreviewEmpty: "Select at least one column to preview the SQL.",
  createIndexRun: "Create index",
  createIndexSuccess: "Created the index.",
  ...
  // インデックス削除 (#850)。ツリーのインデックスノード右クリックから。
  dropIndexConfirmTitle: "Drop index {index}?",
  dropIndexConfirmBody: "This permanently removes the index {index} on {table}. This cannot be undone.",
  dropIndexConfirmOk: "Drop index",
  dropIndexSuccess: "Dropped the index {index}.",
  dropIndexPrimaryDisabled: "Cannot drop a primary key index this way.",
  ...
  objGroupTables: "Tables",
  treeColumnsLabel: "Columns",
  treeForeignKeysLabel: "Foreign keys",
  treeFkOpenHint: "Open the referenced table {table}",
  explorerContainerDatabase: "Database",
  explorerContainerSchema: "Schema",
  contextMenuOpenData: "Open data",
  contextMenuOpenStructure: "Show structure",
  contextMenuShowDefinition: "Show definition",
  sidebarResizeAria: "Resize the sidebar",
  structureTitle: "Structure",
  timelapseTitle: "Timelapse",
  timelapseMenuLabel: "Watch table (timelapse)…",
  timelapseCaptureNow: "Capture now",
  timelapseUsage: "Stored locally: {size}",
  timelapseLoadError: "Failed to load table timelapse: {error}",
  timelapseRetry: "Retry",
  timelapseEmptyTitle: "No watched tables yet",
  timelapseEmptyDescription: "Right-click a table in the schema tree and choose “Watch table (timelapse)” to keep generation snapshots and compare any two. Intended for small master/config tables (up to {limit} rows, primary key required); history of large tables is out of scope.",
  timelapseWatchListAria: "Watched tables",
  timelapseGenerationCount: "{count} generations",
  timelapseInactive: "unwatched",
  timelapsePartial: "partial",
  timelapseUnwatch: "Unwatch",
  timelapseNeedTwo: "At least two different generations are needed to show a diff. A new generation is saved when the table content changes (on connect or “Capture now”).",
  timelapseFrom: "Older generation",
  timelapseTo: "Newer generation",
  timelapseLatest: "latest",
  timelapseRows: "{count} rows",
  timelapseLatestVsPrevious: "Latest ↔ previous",
  timelapseDiffError: "Failed to compute the diff: {error}",
  timelapseCountAdded: "Added: {count}",
  timelapseCountChanged: "Changed: {count}",
  timelapseCountRemoved: "Removed: {count}",
  timelapsePartialNote: "A generation is partial (only the first {limit} rows by primary key were captured). Rows beyond that range may show up as added or removed.",
  timelapseColumnsAdded: "Columns added: {columns}",
  timelapseColumnsRemoved: "Columns removed (not compared): {columns}",
  timelapseMaskedNote: "Sensitive columns are masked for display only. Snapshots store the actual values locally.",
  timelapseNoChanges: "No row differences between these generations.",
  timelapseDiffAria: "Row differences between generations",
  timelapseChangeColumn: "Change",
  timelapseKindAdded: "Added",
  timelapseKindRemoved: "Removed",
  timelapseKindChanged: "Changed",
  timelapseWatchConfirmTitle: "Watch “{table}”?",
  timelapseWatchScope: "Snapshots are taken on connect and on “Capture now”, and a new generation is kept only when the content changed. Meant for small master/config tables (up to {limit} rows); history of large tables is out of scope.",
  timelapseWatchPk: "The table must have a primary key (used to track rows between generations).",
  timelapseWatchPrivacy: "Snapshots are a local copy of real data and may contain sensitive values. They are stored only on this device, in the app data directory (table_timelapse.sqlite), and are never sent anywhere. You can delete them when unwatching or from Settings.",
  timelapseWatchMask: "Sensitive-column masking applies to the display only; stored snapshots are not masked. Snapshots are read-only SELECTs and are not recorded in query history.",
  timelapseWatchConfirmOk: "Start watching",
  timelapseOverLimitTitle: "This table has more than {limit} rows",
  timelapseOverLimitMessage: "Only the first {limit} rows (ordered by primary key) can be recorded. Changes outside that range will not be detected. Record the first {limit} rows anyway?",
  timelapseOverLimitOk: "Record first {limit} rows",
  timelapseWatchDeclined: "Not watched: the table exceeds {limit} rows.",
  timelapseWatched: "Now watching {table}.",
  timelapseCaptureChanged: "New generation saved: {tables}",
  timelapseCaptureUnchanged: "No changes since the last generation.",
  timelapseUnwatchTitle: "Unwatch “{table}”?",
  timelapseUnwatchMessage: "Automatic snapshots of this table stop.",
  timelapseDeleteDataTitle: "Delete saved generations?",
  timelapseDeleteDataMessage: "{count} saved generations of {table} remain on this device. Delete them, or keep them to browse later?",
  timelapseDeleteDataOk: "Delete data",
  timelapseKeepData: "Keep data",
  timelapseCaptureChangedToast: "Table timelapse: content changed in {tables}",
  timelapseCaptureFailedToast: "Table timelapse: could not snapshot {tables}",
  settingsTimelapse: "Table timelapse",
  settingsTimelapseHelp: "Keeps generation snapshots of watched tables in a local-only store under the app data directory. Snapshots are real data copies and are never sent anywhere.",
  settingsTimelapseOnConnect: "Snapshot watched tables on connect",
  settingsTimelapseOnConnectHelp: "Runs one read-only SELECT per watched table right after connecting (not recorded in history).",
  settingsTimelapseMaxGenerations: "Generations kept per table",
  settingsTimelapseMaxGenerationsHelp: "Older generations are deleted first. Total storage is also capped at 64 MiB.",
  settingsTimelapseClearAll: "Delete all timelapse data",
  settingsTimelapseClearTitle: "Delete all table timelapse data?",
  settingsTimelapseClearMessage: "All watches and saved generations for every connection are deleted from this device. This cannot be undone.",
  settingsTimelapseCleared: "Deleted {count} saved generations.",
  structureOpenData: "Open data",
  structureReload: "Reload",
  structureLoading: "Loading the table structure…",
  structureLoadError: "Could not load the table structure: {error}",
  structureColumns: "Columns",
  structureColName: "Column",
  structureColType: "Type",
  structureColNullable: "Nullable",
  structureColDefault: "Default",
  structureColKeys: "Keys",
  structureNullableYes: "NULL",
  structureNullableNo: "NOT NULL",
  structureKeyFk: "FK",
  structureOpenReferencedHint: "Show the structure of the referenced table",
  structureIndexName: "Index",
  structureIndexColumns: "Columns",
  structureIndexKind: "Kind",
  structureNoIndexes: "No indexes.",
  structureForeignKeys: "Foreign keys",
  structureNoForeignKeys: "No foreign keys.",
  structureFkReferences: "References",
  cmdkFocusExplorer: "Filter the Database Explorer",
  cmdkTableStructure: "Structure: {table}",
  treeLoading: "Loading...",
  ...
  colTipExtra: "Extra",
  colTipComment: "Comment",
  alterTableTableComment: "Table comment",
  alterTableCommentPlaceholder: "Describe what this table holds",
  alterTableCommentUnsupported: "SQLite has no table/column comments, so comments cannot be shown or edited.",
  alterTableColComment: "Comment",
  alterTableColCommentAria: "Comment for column {column}",
  ...
  gridSearchPlaceholder: "Filter all columns...",
  gridSearchAria: "Filter across all columns",
  gridFindAria: "Find in results",
  gridFindInputAria: "Find in results query",
  gridFindPlaceholder: "Find in results...",
  gridFindCaseTitle: "Match case",
  gridFindWholeTitle: "Match whole cell value",
  gridFindRegexTitle: "Regular expression",
  gridFindCount: "{current} / {total}",
  gridFindNoHits: "No matches",
  gridFindInvalidRegex: "Invalid regular expression",
  gridFindPrevTitle: "Previous match (Shift+Enter)",
  gridFindNextTitle: "Next match (Enter)",
  gridFindCloseTitle: "Close find (Esc)",
  ...
  gridServerFilterOpNe: "Not equal to",
  ...
  gridNullBarAria: "{column}: {percent}% NULL of {count} loaded rows",
  ...
  gridFooterLabel: "Aggregate footer",
  gridFooterShow: "Show aggregate footer",
  gridFooterHide: "Hide aggregate footer",
  gridFooterFnNone: "None",
  gridFooterAria: "Aggregate footer row",
  gridFooterSelectAria: "Footer aggregate for {column}",
  gridStopButton: "Stop",
  ...
  gridQuickFilterTitleServer:
    "Applies as a server-side WHERE across the whole table. Excluding a value also drops NULL rows (SQL three-valued logic).",
  ...
  valuePickerFk: "FK → {target}",
  valuePickerEnum: "ENUM",
  valuePickerSet: "SET",
  valuePickerCheck: "CHECK",
  valuePickerTitleFk: "Suggests existing values of {target} (prefix search, up to {limit}). Free input is still allowed.",
  valuePickerTitleAllowed: "Suggests the values allowed by the column's type or CHECK constraint. Free input is still allowed.",
  ...
  cellViewerEdit: "Edit",
  cellViewerSave: "Save",
  cellViewerCancel: "Cancel",
  cellViewerSetNull: "Set NULL",
  cellViewerFormat: "Format",
  cellViewerMinify: "Minify",
  cellViewerInvalidJson: "Invalid JSON — fix it before saving.",
  cellViewerViewMode: "Display mode",
  cellViewerViewTree: "Tree",
  cellViewerViewText: "Text",
  jsonTreeAria: "JSON tree",
  jsonTreeSearchPlaceholder: "Search keys and values",
  jsonTreeSearchCount: "{count} matches",
  jsonTreeSearchTruncated: "First {count} matches (truncated)",
  jsonTreeNoMatches: "No matching keys or values",
  jsonTreeKeys: "{n} keys",
  jsonTreeItems: "{n} items",
  jsonTreeShowMore: "Show {n} more",
  jsonTreeSelectHint: "Select a node to copy its path or SQL.",
  jsonTreeCopyPath: "Copy path",
  jsonTreeCopyValue: "Copy value",
  jsonTreeCopySqlExpr: "Copy SQL expression",
  jsonTreeCopySqlWhere: "Copy WHERE condition",
  jsonTreeCopied: "Copied to clipboard",
  ...
  contextMenuGenerateTestData: "Generate test data...",
  ...
  // Create a new table from the file (#985).
  importNewTableTitle: "Import file into a new table",
  importCreateNewTable: "Create a new table",
  importNewTableName: "New table name",
  importNewTableColumns: "Columns (name / type)",
  importNewTableHint:
    "Types are inferred from the preview rows (up to 50). Override any column whose type looks wrong. Unsupported types degrade per database (e.g. SQLite stores dates as TEXT).",
  importNewTableInferred: "inferred: {type}",
  importNewTableInclude: "Import column {name}",
  importNewTableColumnName: "Column name for field {n}",
  importNewTableColumnType: "Type of column {name}",
  importNewTableDdl: "CREATE TABLE preview",
  importNewTableAbortHint:
    "If the load fails in abort mode, the new table is dropped again. Cancelling mid-load leaves the (empty) table.",
  importNewTableNameRequired: "Enter a table name.",
  importNewTableNameWhitespace: "Names must not start or end with a space: \"{name}\"",
  importNewTableNameTooLong: "\"{name}\" is longer than {limit} characters allowed by this database.",
  importNewTableNoColumns: "Select at least one column to import.",
  importNewTableColumnNameRequired: "Every imported column needs a name.",
  importNewTableDuplicateColumn: "Duplicate column name (case-insensitive): {name}",
  importNewTableCreated: "Created table {table}.",
  importTypeInteger: "Integer",
  importTypeBigint: "Big integer (64-bit)",
  importTypeDecimal: "Decimal",
  importTypeDouble: "Floating point",
  importTypeBoolean: "Boolean",
  importTypeDate: "Date",
  importTypeDatetime: "Date & time",
  importTypeText: "Text",
  contextMenuImportNewTable: "New table from file...",

  // スキーマに基づくテストデータ生成 (#602)
  testDataTitle: "Generate test data into {table}",
  testDataClose: "Close",
  testDataHint:
    "Generates dummy rows from the table schema and inserts them in a single all-or-nothing transaction. Defaults are inferred per column type; foreign keys pick from existing referenced values. The same seed always produces the same rows.",
  testDataRowCount: "Rows",
  testDataRowCountInvalid: "Enter a row count between 1 and {max}.",
  testDataSeed: "Seed",
  testDataReseed: "New seed",
  testDataLoading: "Loading table schema...",
  testDataColumnsTitle: "Column generators",
  testDataStrategyAria: "Generator for column {column}",
  testDataStrategySerial: "Sequential number",
  testDataStrategyUuid: "UUID",
  testDataStrategyRandomNumber: "Random number",
  testDataStrategyRandomString: "Random string",
  testDataStrategyRandomDate: "Random date/time",
  testDataStrategyRandomBool: "Random boolean",
  testDataStrategyFixed: "Fixed value",
  testDataStrategyChoice: "Random from enum values",
  testDataStrategyFkRef: "Random from referenced rows",
  testDataStrategyOmit: "Skip (DB default)",
  testDataFixedValue: "Value",
  testDataSerialStart: "Start",
  testDataLength: "Length",
  testDataMin: "Min",
  testDataMax: "Max",
  testDataNullRate: "NULL %",
  testDataNullRateAria: "NULL rate (%) for column {column}",
  testDataFkSource: "from {table}.{column} ({count} values)",
  testDataFkEmpty:
    "No referenced values found for: {columns}. Those columns will be NULL — insert rows into the referenced tables first.",
  testDataNoColumns: "Every column is skipped — nothing to insert.",
  testDataPreviewTitle: "Preview (first {count} rows)",
  testDataRunningStatus: "Inserting {count} rows...",
  testDataRun: "Insert",
  testDataRunning: "Inserting...",
  testDataSuccess: "Inserted {count} test rows into {table} ({ms} ms).",
  testDataProductionConfirmTitle: "Insert test data into {table}?",
  testDataProductionConfirmBody:
    "This connection is marked as production. {count} generated rows will be written to {table}. This cannot be undone easily.",
  ...
  helpShortcutSearchDesc: "Open the find-in-results bar and highlight matching cells across the fetched rows.",
  shortcutFindNavTitle: "Enter / Shift+Enter (in find bar)",
  shortcutFindNavDesc: "Jump to the next / previous match. Esc closes the bar and returns focus to the grid.",
  ...
  resultRestoreTitle: "Restore the result panel (Esc / Cmd/Ctrl+Shift+M)",
  resultMaximizedLabel: "Result (maximized)",
  shortcutFocusEditorTitle: "Cmd/Ctrl+Shift+E",
  shortcutFocusEditorDesc: "Toggle editor focus mode (maximize the editor).",
  editorFocusTitle: "Focus the editor (Cmd/Ctrl+Shift+E)",
  editorRestoreTitle: "Restore the layout (Esc / Cmd/Ctrl+Shift+E)",
  editorFocusedLabel: "Editor (focused)",
  ...
  appSchemaDrift: "Schema drift timeline",
  appSchemaDriftUnsupported: "Connect with a default database selected",
  ...
  pinCompareEmpty: "No pinned results yet. Use the pin button on a result to keep it here.",
  pinCompareEmptyHint: "Pin a result first (pin button on the result toolbar)",
  pinCompareSelect: "Select a pinned result to show here.",
  pinCompareLeft: "Left",
  pinCompareRight: "Right",
  pinCompareKeyColumn: "Key column",
  pinCompareDiff: "Highlight row diff",
  pinCompareNotComparable: "Columns differ — row diff is unavailable",
  pinCompareUnpin: "Unpin right",
  pinCompareClearAll: "Clear all",
  pinCompareClose: "Close",

  // 環境横断ブロードキャスト実行 (#738)
  editorBroadcast: "Run on multiple connections",
  editorBroadcastTitle: "Run this read-only query on several connections at once and compare the results.",
  broadcastDisabledSingle: "Open a second connection using the same driver to broadcast a query.",
  broadcastBlockedToast: "Broadcast execution allows only read-only statements.",
  broadcastPickerTitle: "Run on multiple connections",
  broadcastPickerReadOnlyNotice: "Read-only queries only — write statements are always rejected.",
  broadcastBaselineLabel: "baseline",
  broadcastPickerEmpty: "No other connections use the same driver as the current one.",
  broadcastPickerCancel: "Cancel",
  broadcastPickerRun: "Run",
  broadcastProductionConfirmTitle: "Production connection included",
  broadcastProductionConfirmMessage: "This broadcast includes production connection(s): {names}. Continue?",
  broadcastProductionConfirmAction: "Run anyway",
  broadcastResultsTitle: "Broadcast results",
  broadcastClose: "Close",
  broadcastCancelAll: "Cancel all",
  broadcastCancelEntry: "Cancel this connection",
  broadcastKeyColumnLabel: "Key column (for row diff)",
  broadcastKeyColumnNone: "None — compare by row hash",
  broadcastStatusRunning: "Running…",
  broadcastStatusDone: "Done",
  broadcastStatusError: "Error",
  broadcastStatusCancelled: "Cancelled",
  broadcastRowCount: "{rows} rows",
  broadcastErrorLabel: "Error: {error}",
  broadcastDiffNone: "No differences",
  broadcastDiffPk: "{changed} cells changed, +{added} added, -{removed} missing",
  broadcastDiffHash: "+{added} added, -{removed} missing (no primary key — added/missing rows only)",
  broadcastDiffIncomparable: "Columns differ from the baseline — comparison is unavailable",
  broadcastDiffTruncated: "Compared the first {max} rows only",
  broadcastDiffPending: "Waiting for the baseline and this connection to finish…",
  ...
  erDiagramLayoutLR: "Left → right",
  erDiagramLayoutTB: "Top → bottom",
  erDiagramDensity: "Spacing",
  erDiagramDensityComfortable: "Comfortable",
  erDiagramDensityCompact: "Compact",
  ...
  // マイグレーションファイルとしての保存 (#744)
  schemaCompareSaveMigration: "Save as migration...",
  schemaCompareMigrationTitle: "Save as migration files",
  schemaCompareMigrationDesc:
    "Writes the sync plan as up/down migration files for Flyway, golang-migrate, sqlx or a generic layout. The up file is exactly the plan you already generated; the down file is a fresh plan generated by comparing source and target with the sides swapped. This only writes local files — nothing is applied to either database.",
  schemaCompareMigrationFormat: "Format",
  schemaCompareMigrationFormatFlyway: "Flyway (V/U prefixed)",
  schemaCompareMigrationFormatGolangMigrate: "golang-migrate (.up/.down)",
  schemaCompareMigrationFormatSqlx: "sqlx (-r, .up/.down)",
  schemaCompareMigrationFormatGeneric: "Generic (.up/.down)",
  schemaCompareMigrationName: "Migration name",
  schemaCompareMigrationNameHint: "Saved as: {name}",
  schemaCompareMigrationFiles: "File names",
  schemaCompareMigrationLoadingDown: "Generating the down migration (comparing with sides swapped)...",
  schemaCompareMigrationDownError: "Failed to generate the down migration: {error}",
  schemaCompareMigrationSummary:
    "up: {upCount} statement(s) · down: {downCount} statement(s) · {warnings} warning(s) (recorded as SQL comments)",
  schemaCompareMigrationSaveTitle: "Save migration files",
  schemaCompareMigrationCancel: "Cancel",
  schemaCompareMigrationSave: "Save",
  schemaCompareMigrationSaving: "Saving...",
  schemaCompareMigrationSaved: "Saved:\nup:   {up}\ndown: {down}",
  schemaCompareMigrationError: "Failed to save migration files: {error}",
  ...
  usersClose: "Close users panel",
  usersDesc:
    "MySQL accounts (mysql.user) / PostgreSQL roles (pg_roles). Select a user or role to view and edit its per-table privilege matrix (SELECT/INSERT/UPDATE/DELETE/DDL). All changes go through a generate SQL → preview → confirm → apply flow, same as schema sync.",
  usersRefresh: "Refresh",
  usersRetry: "Retry",
  usersLoadError: "Failed to load users: {error}",
  usersEmpty: "No users to show.",
  usersReadOnlyHint: "This is a read-only session: user/privilege changes are disabled (enforced by the backend).",
  usersSelectUserHint: "Select a user or role to view its privileges.",
  usersSuperuserBadge: "SUPERUSER",
  usersNewUser: "New user…",
  usersCreateNameLabel: "Name",
  usersCreateHostLabel: "Host (MySQL account host pattern, e.g. %, localhost)",
  usersCreatePasswordLabel: "Password (optional)",
  usersCreateCancel: "Cancel",
  usersCreateSubmit: "Create",
  usersCreateConfirmTitle: "Create user",
  usersCreateConfirmMessage: "The following SQL will be executed:",
  usersCreateConfirmOk: "Create",
  usersCreateDone: "Created user {name}",
  usersCreateFailed: "Failed to create user: {error}",
  usersChangePassword: "Change password…",
  usersPasswordLabel: "New password",
  usersPasswordCancel: "Cancel",
  usersPasswordSubmit: "Change",
  usersPasswordConfirmTitle: "Change password",
  usersPasswordConfirmMessage: "The following SQL will change {name}'s password:",
  usersPasswordConfirmOk: "Change password",
  usersPasswordDone: "Password changed",
  usersPasswordFailed: "Failed to change password: {error}",
  usersDropUser: "Delete user",
  usersDropConfirmTitle: "Delete user",
  usersDropConfirmMessage: "Permanently delete {name}? This cannot be undone.",
  usersDropConfirmOk: "Delete",
  usersDropDone: "Deleted user {name}",
  usersDropFailed: "Failed to delete user: {error}",
  usersGlobalRowHint:
    "Server-wide (global) privileges from mysql.user. Shown for reference only — this panel edits per-table privileges within the current database, which is a different scope from a global GRANT ... ON *.*.",
  usersNeedDatabaseHint: "Open a database to view and edit its table-level privileges.",
  usersPrivilegesLoadError: "Failed to load privileges: {error}",
  usersPrivilegesEmpty: "No table-level grants in the current database. Add a table below to grant privileges.",
  usersColTable: "Table",
  usersColSelect: "SELECT",
  usersColInsert: "INSERT",
  usersColUpdate: "UPDATE",
  usersColDelete: "DELETE",
  usersColDdl: "DDL",
  usersColDdlHint:
    "Bundles the schema-altering grants this driver exposes per table — MySQL: CREATE, ALTER, DROP, INDEX, REFERENCES. PostgreSQL: TRUNCATE, REFERENCES, TRIGGER.",
  usersAddTablePlaceholder: "Table name",
  usersAddTableButton: "Add table",
  usersDiscardChanges: "Discard changes",
  usersApplyChanges: "Apply changes",
  usersApplyConfirmTitle: "Apply privilege changes",
  usersApplyConfirmMessage: "{count} statement(s) will be executed:",
  usersApplyConfirmOk: "Apply",
  usersApplyDone: "Privilege changes applied",
  usersApplyFailed: "Failed to apply privilege changes: {error}",
  usersNoChanges: "No changes to apply.",

  // 監視ダッシュボード (#731)
  processTabProcesses: "Processes",
  processTabMetrics: "Metrics",
  metricsDesc:
  ...
  metricsChartProblems: "Lock waits & slow queries",
  metricsCountUnit: "count",
  metricsQpsUnit: "queries/sec",
  metricsTpsUnit: "transactions/sec",
  metricsPerSecUnit: "events/sec",
  metricsSeriesConnections: "Connections",
  metricsSeriesActive: "Active",
  metricsSeriesIdleInTx: "Idle in transaction",
  metricsSeriesLockWaiting: "Lock waiting",
  metricsSeriesThroughput: "Throughput",
  metricsSeriesLockWaitRate: "Lock waits/sec",
  metricsSeriesSlowQueryRate: "Slow queries/sec",
  ...
  // データ品質アサーション (#742)
  assertTitle: "Data quality",
  appAssertions: "Data quality assertions",
  cmdkAssertions: "Data quality assertions (validate expectations)",
  assertDesc:
    "Register business expectations that are not expressed as DB constraints (no NULLs, unique, accepted values, range, orphan rows, row count) and validate them all at once. Every check is a read-only SELECT: it works on read-only connections, honors the query timeout per rule, and is not recorded in query history.",
  assertRunAll: "Validate all",
  assertCancelRun: "Stop",
  assertAdd: "Add assertion",
  assertSummary: "{passed} passed · {failed} failed · {errored} errors (of {total})",
  assertLoadError: "Could not load assertions: {error}",
  assertRetry: "Retry",
  assertEmptyTitle: "No assertions for this connection yet",
  assertEmptyDesc: "Add a rule such as “email is never NULL” or “status is one of active / banned”.",
  assertColStatus: "Status",
  assertColName: "Name",
  assertColRule: "Rule",
  assertColResult: "Result",
  assertStatusPass: "Pass",
  assertStatusFail: "Fail",
  assertStatusError: "Error",
  assertStatusCancelled: "Stopped",
  assertStatusPending: "Not run",
  assertShowViolations: "Show violations",
  assertRunOne: "Validate this assertion",
  assertEdit: "Edit",
  assertDelete: "Delete",
  assertDeleteTitle: "Delete assertion",
  assertDeleteMessage: "Delete the assertion “{name}”? This cannot be undone.",
  assertDeleteError: "Could not delete the assertion: {error}",
  assertSaved: "Assertion saved",
  assertObservedViolations: "{count} violation(s)",
  assertObservedRows: "{count} row(s)",
  assertRuleNotNull: "Not null",
  assertRuleUnique: "Unique",
  assertRuleAcceptedValues: "Accepted values",
  assertRuleRange: "Range",
  assertRuleReferential: "Referential",
  assertRuleRowCount: "Row count",
  assertDescNotNull: "{table}.{column} IS NOT NULL",
  assertDescUnique: "{table} ({columns}) is unique",
  assertDescAcceptedValues: "{table}.{column} ∈ {values}",
  assertDescRange: "{min} ≤ {table}.{column} ≤ {max}",
  assertDescReferential: "{table} ({columns}) → {target} ({refColumns})",
  assertDescRowCount: "rows of {table} {op} {value}",
  assertDescRowCountBetween: "{min} ≤ rows of {table} ≤ {max}",
  assertAddTitle: "Add data quality assertion",
  assertEditTitle: "Edit data quality assertion",
  assertCancel: "Cancel",
  assertSave: "Save",
  assertSaveError: "Could not save: {error}",
  assertFieldName: "Name",
  assertFieldNamePlaceholder: "e.g. users.email is required",
  assertFieldScope: "Show for",
  assertScopeProfile: "This connection",
  assertScopeGroup: "This connection's group",
  assertScopeAny: "All connections",
  assertFieldSchema: "Schema",
  assertFieldSchemaPlaceholder: "(session default)",
  assertFieldTable: "Table",
  assertFieldRule: "Rule",
  assertFieldColumn: "Column",
  assertFieldColumns: "Columns",
  assertFieldColumnsPlaceholder: "col_a, col_b",
  assertFieldValues: "Accepted values (one per line)",
  assertFieldValuesPlaceholder: "active\nbanned",
  assertFieldMin: "Min (inclusive)",
  assertFieldMax: "Max (inclusive)",
  assertFieldBoundPlaceholder: "number or date, blank = open",
  assertFieldRefSchema: "Referenced schema",
  assertFieldRefTable: "Referenced table",
  assertFieldRefColumns: "Referenced columns",
  assertFieldOp: "Condition",
  assertOpBetween: "between",
  assertFieldCount: "Rows",
  assertPreviewCheck: "Check query (read-only)",
  assertPreviewViolations: "Violation query (opened in a new tab)",
  assertPreviewEmpty: "Fill in the rule to preview the generated SQL.",
  assertErrName: "Enter a name.",
  assertErrTable: "Enter the table.",
  assertErrColumn: "Enter the column.",
  assertErrColumns: "Enter at least one column.",
  assertErrValues: "Enter at least one accepted value.",
  assertErrBounds: "Enter a min, a max, or both.",
  assertErrRefTable: "Enter the referenced table.",
  assertErrRefColumns: "Enter as many referenced columns as source columns.",
  assertErrCount: "Enter a non-negative whole number.",
  assertErrCountMax: "Enter a max that is at least the min.",
  assertErrScopeGroup: "This connection has no group. Choose another scope.",
  ...
  advisorRetry: "Retry",
  // 列データプロファイル (#974)
  profileTitle: "Explore column",
  profileMenuLabel: "Explore columns…",
  profileExploreColumn: "Explore column…",
  profileDesc:
    "Aggregates the whole table on the server (not just fetched rows): null rate, distinct count, min / max, most frequent values and — for numeric columns — a histogram. Read-only SELECTs only.",
  profileColumnLabel: "Column",
  profileSelectColumn: "Select a column",
  profileApproximate: "Approximate distinct (faster)",
  profileApproximateHint:
    "PostgreSQL reads the planner statistics and DuckDB uses approx_count_distinct instead of an exact COUNT(DISTINCT). Other drivers always count exactly.",
  profileRun: "Profile",
  profileRerun: "Re-run",
  profileRunning: "Aggregating the whole table…",
  profileError: "Profiling failed: {error}",
  profileRetry: "Retry",
  profileLoadColumnsError: "Could not load columns: {error}",
  profileEmpty: "Pick a column and run the profile",
  profileTotal: "Rows",
  profileNulls: "NULL",
  profileDistinct: "Distinct",
  profileMin: "Min",
  profileMax: "Max",
  profileType: "Type",
  profileApproxMark: "≈ approximate",
  profileHistogram: "Histogram",
  profileTopValues: "Most frequent values",
  profileValue: "Value",
  profileCount: "Count",
  profileShare: "Share",
  profileNoValues: "No non-NULL values",
  profileNoteStatsUnavailable:
    "This column type does not support DISTINCT / MIN / MAX on this server, so only counts are shown.",
  profileNoteTopUnavailable: "This column type cannot be grouped, so the most frequent values are not shown.",
  profileNoteHistogramUnavailable: "A histogram could not be computed for this column.",
  profileNoteApproxUnsupported: "Approximate distinct is not available on this driver; the exact count is shown.",
  profileNoteApproxNoStats:
    "No planner statistics for this column yet (run ANALYZE); the exact distinct count is shown.",
  profileNoteUnknown: "Part of the profile could not be computed.",
  ...
  maintenanceOptimize: "Optimize (rebuild & defragment)",
  maintenanceCheck: "Check (integrity)",
  ...
  maintenanceConfirmOk: "Run",
  maintenanceReadOnlyTitle: "Disabled on a read-only session",
  maintenanceDone: "Maintenance finished on {target}",
  maintenanceFailed: "Maintenance failed: {error}",

  // テーブル/DB サイズ・統計ダッシュボード (#562)
  sizeTitle: "Size & statistics",
  sizeClose: "Close size dashboard",
  sizeDesc:
  ...
  sizePkYes: "Yes",
  sizePkNo: "No",
  sizeFilterName: "Filter tables…",
  sizeFilterNoIndex: "No index",
  sizeFilterNoPk: "No PK",
  sizeFilterCount: "Showing {shown} of {total}",
  sizeNoMatch: "No tables match the filter.",
  sizeOpenTable: "Open table {table}",
  sizeTotalsLabel: "Total ({count} tables)",
  sizeLoadError: "Failed to load sizes: {error}",
  sizeEmpty: "No tables to show.",
  sizeMenuLabel: "Size & statistics…",

  // サーバ / 接続情報パネル (#563)
  serverInfoTitle: "Server info",
  serverInfoClose: "Close server info",
  serverInfoDesc:
  ...
  serverInfoColValue: "Value",
  serverInfoVarCount: "{shown} of {total} variables",
  serverInfoLoadError: "Failed to load server info: {error}",
  serverInfoEmpty: "No variables match your search.",
  serverInfoMenuLabel: "Server info…",
  ...
  taskManagerClose: "Close",
  taskCreate: "New task",
  taskNoProfiles: "Add a connection profile first to create a scheduled task.",
  taskLoadError: "Failed to load tasks: {error}",
  taskRetry: "Retry",
  taskEmpty: "No scheduled tasks yet.",
  taskToggleEnabled: "Enable/disable \"{name}\"",
  taskNextRun: "Next run",
  taskDisabled: "Disabled",
  taskLastOk: "Last run: ok",
  taskLastError: "Last run: error",
  taskRunNow: "Run now",
  taskHistory: "Run history",
  taskEdit: "Edit",
  taskDelete: "Delete",
  taskHistoryEmpty: "No runs yet.",
  taskHistoryClear: "Clear run history",
  taskHistoryClearConfirm: 'Delete all run history for "{name}"? This cannot be undone.',
  taskRunCatchUp: "catch-up",
  taskRunRows: "{rows} rows",
  taskRunBytes: "{bytes} bytes",
  taskDeleteConfirmTitle: "Delete task?",
  taskDeleteConfirmMessage: "Delete the scheduled task \"{name}\"? Its run history will also be removed.",
  taskDeleteConfirmOk: "Delete",
  taskDeleted: "Deleted task \"{name}\".",
  taskRunOk: "\"{name}\" ran successfully.",
  taskRunFailed: "\"{name}\" failed: {error}",
  taskRunNotifyTitle: "Scheduled task failed: {name}",
  taskFormName: "Name",
  taskFormProfile: "Connection",
  taskFormProductionBadge: "production",
  taskFormActionKind: "Action",
  taskFormActionExport: "Run query → export to file",
  taskFormActionDump: "Database dump",
  taskFormSql: "SQL (read-only only)",
  taskFormSqlRequired: "Enter a SQL statement.",
  taskFormSqlNotReadOnly:
    "Scheduled tasks only support read-only statements (SELECT / SHOW / DESCRIBE / EXPLAIN / WITH).",
  taskFormDatabaseOptional: "Database (optional)",
  taskFormDatabase: "Database",
  taskFormDatabaseRequired: "Enter a database name.",
  taskFormOutputPath: "Output path",
  taskFormOutputPathPlaceholder: "e.g. sales-{date}.csv",
  taskFormOutputPathHint:
    "{date} expands to YYYY-MM-DD and {datetime} to YYYYMMDD-HHMMSS (UTC) at run time.",
  taskFormOutputPathPreview: "preview: {path}",
  taskFormOutputPathRequired: "Enter an output path.",
  taskFormSchedule: "Schedule",
  taskScheduleInterval: "Every N minutes",
  taskScheduleDaily: "Daily at",
  taskScheduleMinutes: "minutes",
  taskScheduleUtcHint: "(UTC)",
  taskFormEnabled: "Enabled",
  taskFormCancel: "Cancel",
  taskFormSave: "Save",
  taskFormNameRequired: "Enter a task name.",
  taskFormProfileRequired: "Choose a connection.",
  taskProductionConfirmTitle: "Schedule a task on a production connection?",
  taskProductionConfirmMessage:
    "\"{name}\" is marked as a production connection. Scheduled tasks on it will keep running automatically while the app is open — continue?",
  taskProductionConfirmOk: "Continue",
  taskSaved: "Saved task \"{name}\".",
  taskOutputPathBrowseTitle: "Choose an output file",
  taskCatchUpMissed:
    "Catch up on a schedule missed while the app was closed (runs once on next launch)",
  helpTaskSchedulerTitle: "Scheduled tasks",
  helpTaskSchedulerDesc:
  ...
  // --- SQL Editor / Result Grid UX (#1113) ---
  shortcutExplainTitle: "Cmd/Ctrl+E",
  shortcutExplainDesc: "Show the execution plan (EXPLAIN) of the selection, or the whole editor.",
  editorMenuRunAll: "Run query",
  editorMenuRunSelection: "Run selection",
  editorMenuExplainRun: "Explain",
  editorMenuRunStatement: "Run statement at cursor",
  editorMenuPreview: "Dry run",
  editorMenuExplain: "Explain (execution plan)",
  editorMenuFormatAll: "Format SQL",
  editorMenuFormatSelection: "Format selection",
  editorMenuToggleComment: "Toggle line comment",
  editorMenuCut: "Cut",
  editorMenuCopy: "Copy",
  editorMenuSelectAll: "Select all",
  editorMenuNeedsSelection: "Select some text first",
  cmdkRunQuery: "Run query",
  cmdkExplainRun: "Run EXPLAIN",
  cmdkRunSelected: "Run selected / statement at cursor",
  cmdkExplainQuery: "Explain query",
  cmdkFormatSql: "Format SQL",
  cmdkFocusEditor: "Move focus to the SQL editor",
  cmdkToggleActivity: "Show / hide activity",
  cmdkSwitchConnection: "Switch connection: {name}",
  gridCopyAsCsv: "Copy row as CSV",
  gridCopyAsCsvRows: "Copy {count} rows as CSV",
  gridCopyAsJson: "Copy row as JSON",
  gridCopyAsJsonRows: "Copy {count} rows as JSON",
  resultViewJson: "JSON",
  resultExplain: "Explain",
  resultExplainTitle: "Open the execution plan of the query that produced this result in an EXPLAIN tab",
  resultJsonRows: "{rows} rows",
  resultJsonTruncated: "Showing the first {shown} of {total} rows",
  resultJsonCopy: "Copy JSON",
  resultJsonCopyTitle: "Copy the rows shown here as a JSON array (masked columns stay masked)",
  resultJsonCopied: "Copied {rows} rows as JSON",
  resultJsonEmpty: "No rows to show",
};
...
const ja: Dict = {
  ...
  activityCenterTitle: "アクティビティ",
  activityOpen: "アクティビティ — 最近の通知",
  activityOpenUnread: "アクティビティ — 未読 {count} 件",
  activityClose: "アクティビティを閉じる",
  activityClear: "クリア",
  activityEmpty: "通知はまだありません。作業中に表示されたトーストがここに残ります。",
  activityNoMatches: "この絞り込みに一致する通知はありません。",
  activityFilterAll: "すべて",
  activityFilterAria: "重大度で絞り込み",
  activityListAria: "最近の通知",
  activitySeverityInfo: "情報",
  activitySeveritySuccess: "成功",
  activitySeverityWarning: "警告",
  activitySeverityError: "エラー",
  activityTimeNow: "たった今",
  activityTimeMinutes: "{n} 分前",
  activityTimeHours: "{n} 時間前",
  activityTimeDays: "{n} 日前",
  activityFooterNote: "このセッションの直近 {limit} 件を保持します (終了時は保存されません)。",
  activityOpenInPanel: "パネルで開く",
  activityEmptyTitle: "アクティビティはまだありません",
  messagesTitle: "メッセージ",
  messagesEmptyTitle: "メッセージはまだありません",
  messagesEmpty: "ステータスバーに出たメッセージ (接続・実行結果・エラー) をここに残します。次の操作で上書きされたあとも読み返せます。",
  messagesListAria: "ステータスメッセージの履歴",
  messagesRepeat: "×{count}",
  outputTitle: "出力",
  outputEmptyTitle: "まだ何も実行していません",
  outputEmpty: "実行した文ごとに、件数・所要時間・エラーをここに記録します。",
  outputListAria: "実行した文",
  outputFilterAria: "実行結果の絞り込み",
  outputFilterProblems: "問題あり",
  outputSummaryRows: "{rows} 行 · {ms} ms",
  outputSummaryAffected: "{rows} 行に影響 · {ms} ms",
  ...
  outputCopied: "SQL をコピーしました",
  cmdkOutput: "出力 (実行ログ) を表示",
  cmdkMessages: "メッセージ (ステータス履歴) を表示",
  cmdkActivityPanel: "アクティビティをボトムパネルで表示",
  statusOpenMessages: "メッセージ履歴を表示",
  shortcutModalSubmitTitle: "Cmd/Ctrl+Enter / Esc",
  shortcutModalSubmitDesc: "ダイアログ / フォームで主アクションを実行します (Esc は実行せずに閉じます)。",
  ...
  healthRefresh: "今すぐ確認",
  healthIncludeSaved: "保存済みプロファイルも表示",
  healthColName: "接続",
  healthColStatus: "状態",
  healthColLatency: "レイテンシ",
  healthColVersion: "バージョン",
  healthColConnections: "接続数",
  healthColActions: "操作",
  healthStatusUp: "稼働中",
  healthStatusDown: "停止",
  healthStatusTimeout: "タイムアウト",
  healthStatusUnknown: "確認中…",
  healthStatusNotConnected: "未接続",
  healthNa: "N/A",
  healthNaHint: "サーバを持たない (ファイルベースの) データベースです",
  healthLatencyMs: "{ms} ms",
  healthActive: "使用中",
  healthReadOnly: "読み取り専用",
  healthSwitch: "切替",
  healthConnect: "接続",
  healthReconnect: "再接続",
  healthReconnected: "{name} に再接続しました",
  healthReconnectFailed: "{name} に再接続できませんでした",
  healthSummary: "{open} 本中 {up} 本が稼働中",
  healthSummaryDown: "停止 {count}",
  healthSummaryTimeout: "タイムアウト {count}",
  healthSummaryLatency: "中央値 {median} ms · 最大 {max} ms",
  healthEmpty: "開いている接続はありません",
  healthUpdatedAt: "{time} 更新",
  healthTableAria: "接続ごとのヘルス",
  ...
  historySaveAsSnippet: "スニペットとして保存",
  historyStatusError: "エラー",
  historyRowsMeta: "{rows} 件取得",
  historyAffectedMeta: "影響 {rows} 件",
  historyStatusFilterLabel: "ステータスで絞り込み",
  historyStatusFilterAll: "すべて",
  historyStatusFilterOk: "成功のみ",
  historyStatusFilterError: "失敗のみ",
  historyPeriodFilterLabel: "期間で絞り込み",
  historyPeriodFilterAll: "全期間",
  historyPeriodFilterToday: "今日",
  historyPeriodFilterWeek: "直近7日",
  ...
  snippetMenuWatchPlan: "実行計画をウォッチ",
  snippetMenuUnwatchPlan: "実行計画のウォッチを解除",
  snippetWatchBadge: "実行計画をウォッチ中",
  snippetOpenPlanWatch: "実行計画ウォッチ",
  planWatchTitle: "実行計画ウォッチ — {name}",
  planWatchClose: "閉じる",
  planWatchEmptyTitle: "ウォッチ中のスニペットはありません",
  planWatchEmpty: "スニペットを右クリックして「実行計画をウォッチ」を選ぶと、EXPLAIN 計画の世代を記録してリグレッションを検知できます。",
  planWatchSnippetMissing: "(削除されたスニペット)",
  planWatchGenerationCount: "{count} 世代",
  planWatchNoGenerations: "まだ計画が記録されていません。接続中に更新すると最初の世代を記録します。",
  planWatchCompareFrom: "比較元",
  planWatchCompareTo: "比較先",
  planWatchLatestOption: "{time} (最新)",
  planWatchPaneFrom: "比較元 (古い)",
  planWatchPaneTo: "比較先 (新しい)",
  planWatchNoChanges: "選択した世代間に構造的な変化はありません。",
  planWatchChangeAccess: "{object}: アクセス方式が変化 {before} → {after}",
  planWatchChangeIndex: "{object}: 使用インデックスが変化 {before} → {after}",
  planWatchChangeJoin: "{object}: 結合方式が変化 {before} → {after}",
  planWatchChangeRows: "{object}: 推定行数が変化 {before} → {after}",
  planWatchChangeAdded: "{object}: オペレーションが追加 ({after})",
  planWatchChangeRemoved: "{object}: オペレーションが削除 ({before})",
  planWatchUnwatch: "ウォッチ解除",
  planWatchUnwatchHint: "このスニペットをウォッチから外し、保存済みの世代を削除します。",
  planWatchRefresh: "計画を更新",
  planWatchRefreshing: "更新中...",
  planWatchRefreshHint: "ウォッチ中の全スニペットの EXPLAIN を実行し、計画が変化していれば新しい世代として記録します。",
  planWatchNeedConnection: "計画を更新するにはこのプロファイルに接続してください。",
  planWatchLocalOnlyNote: "計画はローカルにのみ保存されます。EXPLAIN は読み取り操作のみで、クエリ履歴には記録されません。",
  planWatchChangedToast: "{count} 件のウォッチ中スニペットで実行計画が変化しました",
  planWatchRefreshFailedToast: "{name} の計画チェックに失敗: {error}",

  schemaDriftTitle: "スキーマドリフト・タイムライン — {name}",
  schemaDriftClose: "閉じる",
  schemaDriftEmptyTitle: "まだスナップショットがありません",
  schemaDriftEmpty: "このプロファイルに接続すると最初のスキーマスナップショットを記録します (オフの場合は設定の「接続時にスキーマをスナップショット」を有効にしてください)。",
  schemaDriftGenerationTables: "{count} テーブル",
  schemaDriftLatestSuffix: "(最新)",
  schemaDriftOmittedBadge: "サイズ超過のため全文は未保存",
  schemaDriftCompareFrom: "比較元",
  schemaDriftCompareTo: "比較先",
  schemaDriftLatestOption: "{time} (最新)",
  ...
  schemaDriftColAdded: "列追加 {count}",
  schemaDriftColRemoved: "列削除 {count}",
  schemaDriftColChanged: "列変更 {count}",
  schemaDriftIdxAdded: "インデックス追加 {count}",
  schemaDriftIdxRemoved: "インデックス削除 {count}",
  schemaDriftIdxChanged: "インデックス変更 {count}",
  schemaDriftCaptureNow: "今すぐスナップショットを取得",
  schemaDriftCapturing: "取得中...",
  schemaDriftCaptureHint: "この接続の既定データベースのスキーマスナップショットを今すぐ取得します。",
  schemaDriftNeedConnection: "スナップショットを取得するにはこのプロファイルに接続してください。",
  schemaDriftLocalOnlyNote: "スナップショットはローカルにのみ保存されます。取得は読み取り操作のみで、クエリ履歴には記録されません。",
  schemaDriftChangedToast: "前回接続時からスキーマが変更されています — {detail}",
  schemaDriftRefreshFailedToast: "スキーマドリフトのチェックに失敗: {error}",
  ...
  settingsShortcutsHelp:
    "主要アクションのキーを再割り当てできます。同一スコープ内で重複すると警告します。変更は即時反映され、チートシート (?) とヘルプにも反映されます。",
  settingsShortcutsResetAll: "すべて既定に戻す",
  settingsShortcutRecord: "変更",
  settingsShortcutRecording: "キーを押す… (Esc で取消)",
  settingsShortcutConflict: "衝突",
  ...
  flightRecorderClearAction: "全消去",
  flightRecorderClearConfirmProfile: "この接続のフライトレコードをすべて削除しますか? この操作は取り消せません。",
  flightRecorderClearConfirmAll: "すべての接続のフライトレコードを削除しますか? この操作は取り消せません。",
  ...
  settingsSchemaDriftOnConnect: "接続時にスキーマをスナップショット",
  settingsSchemaDriftOnConnectHelp: "接続確立時に、そのプロファイルの既定データベースのスキーマスナップショットを取得し、前回のスナップショットと異なれば通知します。読み取り操作のみで、クエリ履歴には記録されません。オフにすると保存済みタイムラインの閲覧のみになります。",
  ...
  shortcutRunStatementTitle: "Cmd/Ctrl+Alt+Enter",
  shortcutRunStatementDesc:
    "カーソル位置にある単一文だけを実行します (選択範囲があればそちらを優先)。",
  ...
  themePresetSolarized: "Solarized",
  themePresetOneDark: "One Dark",
  themePresetHighContrast: "高コントラスト",
  themePresetColorblind: "色覚多様性対応",
  settingsMotionPreference: "モーション量",
  settingsMotionPreferenceHelp: "アプリのアニメーション量を制御します。「システムに従う」は OS の「動きを減らす」設定に追従し、「フル」「控えめ」は OS 設定に関わらずどちらか一方に強制します。",
  settingsMotionPreferenceSystem: "システムに従う",
  settingsMotionPreferenceFull: "フル",
  settingsMotionPreferenceReduced: "控えめ",
  themePreviewChipBg: "背景",
  themePreviewChipSurface: "サーフェス",
  themePreviewChipAccent: "アクセント",
  themePreviewChipText: "テキスト",
  themePreviewChipKeyword: "キーワード",
  ...
  contextMenuDisconnect: "切断する",
  toastDisconnected: "{name} から切断しました",
  toastSwitchedConnection: "{name} に切り替えました",
  listProduction: "本番",
  ...
  statusReconnectingAttempt: "接続が切れました — {name} に再接続しています…（{attempt}/{max} 回目）",
  statusReconnected: "{name} に再接続しました。",
  statusReconnectGaveUp: "{name} への再接続を {max} 回試みましたが失敗しました。セッションを閉じました。手動で再接続してください。",
  statusReconnectBusy: "再接続中です。接続が回復したらクエリを実行します。",
  statusReconnectTx: "トランザクション中に接続が切れました。中途半端なコミットを避けるため自動再接続しません。再接続してトランザクションをやり直してください。",
  ...
  formPickDbFileTitle: "データベースファイルを選択",
  formPickCertTitle: "証明書 / 鍵ファイルを選択",
  formSqliteFileFilter: "SQLite データベース",
  formDuckDbFileFilter: "DuckDB データベース",
  ...
  formDuckDbLegend: "DuckDB",
  formDuckDbFilePath: "データベースファイル",
  formDuckDbFilePathPlaceholder: "/path/to/database.duckdb",
  formDuckDbFilePathHelp: "DuckDB データベースファイルへの絶対パス。ファイルは既に存在している必要があります。",
  formHost: "ホスト",
  formPort: "ポート",
  formUser: "ユーザー",
  ...
  // ツールバーのオーバーフローメニュー (#915)。
  editorMoreActions: "その他の操作",
  editorMoreActionsTitle: "Explain・スニペット・ファイル・一括実行・Query Builder。",
  ...
  qbBoolNull: "NULL",
  qbSetNow: "現在日時をセット",
  qbNotNullWarning: "この列は NOT NULL です。NULL のまま実行すると失敗します。",
  qbLimitInvalid: "LIMIT は整数で指定してください。句は省略されます。",
  qbNoWhereBand: "WHERE 句がありません。テーブルの全行が対象になります。",
  qbValidationNoTable: "先にテーブルを選択してください。",
  qbValidationNoInsertValues: "挿入する列と値を少なくとも 1 つ入力してください。",
  ...
  editApplyConfirmTitle: "本番接続に変更を適用しますか？",
  editApplyConfirmBody: "本番データベースに {count} 件の変更を適用しようとしています。続行しますか？",
  editCancelButton: "破棄",
  ...
  exportFormatSql: "SQL INSERT",
  // 調査バンドル (#745)。
  exportFormatBundle: "調査バンドル (HTML)",
  exportBundleOptions: "バンドルの内容",
  exportBundleDataWarning:
    "この自己完結 HTML には {rows} 行 × {cols} 列の実データが含まれます。共有先を確認してください。",
  exportBundleMasked: "機微カラム {count} 列は伏せ字 (••••) で出力されます (列マスク): {names}",
  exportBundleNoMasked: "機微カラムマスクに該当する列はありません。値はそのまま出力されます。",
  exportBundleNoSecrets: "パスワード・接続文字列は一切含まれません。",
  exportBundleIncludeHost: "ホスト名を含める",
  exportBundleIncludeSchema: "テーブル定義を同梱する",
  exportBundleIncludePlan: "実行計画を同梱する (EXPLAIN を実行)",
  bundleTitle: "noobDB 調査バンドル",
  bundleNotice: "noobDB により {at} に生成。データはこの時点のスナップショットです。",
  bundleSectionMeta: "文脈",
  bundleSectionSql: "クエリ",
  bundleSectionResult: "結果",
  bundleSectionSchema: "テーブル定義",
  bundleSectionPlan: "実行計画",
  bundleGeneratedAt: "生成日時",
  bundleExecutedAt: "実行日時",
  bundleProfile: "接続",
  bundleDriver: "ドライバ",
  bundleDatabase: "データベース",
  bundleHost: "ホスト",
  bundleRows: "行 × 列",
  bundleElapsed: "実行時間",
  bundlePartial: "グリッドに読み込まれた行のみを含みます — 実際の結果はこれより多い可能性があります。",
  bundleMasked: "マスク",
  bundleSortHint: "列見出しをクリックすると並べ替えできます。",
  bundleNoSql: "(クエリの記録なし)",
  bundleNoRows: "(行なし)",
  bundleUnavailable: "取得できませんでした",
  bundleColName: "列",
  bundleColType: "型",
  bundleColNullable: "NULL 可",
  bundleColKey: "キー",
  bundleColDefault: "既定値",
  bundleColExtra: "その他",
  bundleYes: "YES",
  bundleNo: "NO",
  exportFormatXlsx: "Excel (xlsx)",
  ...
  exportSqlHint:
    "ドライバ別のリテラルエスケープで INSERT 文を生成し、指定行数ごとに 1 文へまとめます。",
  imageExportButton: "画像を書き出し",
  imageExportPng: "PNG で保存",
  imageExportSvg: "SVG で保存",
  imageExportCopy: "PNG をクリップボードへコピー",
  imageExportSaved: "{path} に画像を保存しました",
  imageExportCopied: "画像をクリップボードへコピーしました",
  imageExportCopyFailed: "画像をクリップボードへコピーできませんでした",
  imageExportError: "画像の書き出しに失敗しました: {error}",
  exportSavePath: "保存先",
  ...
  // エクスポート時のデータマスキング (#733)。
  exportMasking: "データマスキング",
  exportMaskingEnable: "出力の PII 列をマスクする",
  exportMaskingHint: "書き出すファイルの中身だけを変換し、DB は一切変更しません。列名が保存済みプリセットに一致する列は自動でマスクされます。",
  exportMaskingHashNote: "仮名化は OS キーリングにのみ保存されたアプリ共通の秘密ソルトを鍵にした HMAC-SHA256 です。同じ値は常に同じ仮名になるため、結合キーとして使えます。",
  exportMaskingRuleFor: "{column} のマスキングルール",
  exportMaskingFixedValueFor: "{column} の置換値",
  exportMaskingKeepStartFor: "{column} の先頭に残す文字数",
  exportMaskingKeepEndFor: "{column} の末尾に残す文字数",
  exportMaskingHashLengthFor: "{column} の仮名の長さ",
  exportMaskingKeepStart: "先頭",
  exportMaskingKeepEnd: "末尾",
  exportMaskingHashLength: "長さ",
  exportMaskRuleNone: "マスクしない",
  exportMaskRuleFixed: "固定値に置換",
  exportMaskRulePartial: "部分マスク",
  exportMaskRuleHash: "仮名化 (ハッシュ)",
  exportMaskRuleNull: "NULL にする",
  exportMaskingFromPreset: "プリセット",
  exportMaskingSavePreset: "この列名のプリセットとして保存",
  exportMaskingPresetSaved: "「{column}」をマスキングのプリセットに保存しました",
  exportMaskingNoColumns: "マスクされる列はありません。",
  exportMaskedColumns: "{count} 列をマスク",
  exportMaskingPending: "マスキングを適用しています…",
  exportMaskingError: "マスキングを適用できませんでした: {error}",
  exportMaskedSuffix: "（{count} 列をマスク）",
  // 結果パネルの表示切替セグメント (グリッド / ピボット / チャート)。
  ...
  // 配色 (#916): グリッドの条件付き書式と同じ共有カラースケールから選ぶ。
  chartPalette: "配色",
  chartPalette_categorical: "カテゴリ",
  chartPalette_blue: "ブルー",
  chartPalette_teal: "ティール",
  chartPalette_coolWarm: "寒色 → 暖色",
  chartPalette_blueOrange: "青 → 橙",
  chartPaletteValueColoring: "値の大小で着色 (淡い = 小、濃い = 大)",
  ...
  pivotTotal: "合計",
  pivotInMemoryNote:
    "取得済みの {count} 行を在メモリで集計しています。ソースクエリ全体を DB 側で集計し直すには GROUP BY SQL をエディタへ送ってください。",
  pivotSendSql: "GROUP BY SQL を送る",
  pivotTruncated:
  ...
  // 現在のクエリをビューとして保存 / ビュー定義を編集して置換 (#851)。
  saveAsViewButton: "ビューへ保存",
  saveAsViewButtonTitle: "現在の結果をビューとして保存します (CREATE VIEW ... AS)",
  saveAsViewDisabledTitle:
    "単一の SELECT/WITH クエリで、かつ書き込み可能な接続のときだけビューへ保存できます。",
  saveAsViewTitle: "結果をビューへ保存",
  saveAsViewClose: "閉じる",
  saveAsViewNameLabel: "ビュー名",
  saveAsViewNamePlaceholder: "new_view",
  saveAsViewNameReplaceNote: "ビュー「{view}」は既に存在するため、置き換えられます。",
  saveAsViewListError: "既存ビュー名の確認に失敗しました: {error}",
  saveAsViewPreview: "SQL プレビュー",
  saveAsViewPreviewEmpty: "ビュー名を入力すると SQL がプレビューされます。",
  saveAsViewConfirm: "ビューを作成",
  saveAsViewReplaceConfirm: "ビューを置換",
  saveAsViewSuccess: "結果セットからビュー「{view}」を作成しました。",
  saveAsViewReplaceSuccess: "ビュー「{view}」を置換しました。",
  contextMenuEditViewDefinition: "定義を編集...",
  contextMenuDropView: "ビューを DROP...",
  dropViewConfirmTitle: "{view} を DROP しますか?",
  dropViewConfirmBody: "ビュー {view} を完全に削除します。この操作は取り消せません。",
  dropViewConfirmOk: "DROP VIEW",
  // ローカル横断クエリ (#740): 結果セットをローカル SQLite エンジンへ登録し、
  // 複数接続の結果を横断で再クエリ/JOIN する。
  ...
  dumpNoteNative: "この接続から SQL ダンプ (スキーマの DDL + INSERT 文) を直接生成します。外部のクライアントツールは不要です。",
  ...
  // DB 全体からの値検索 (#748): 「この値はどのテーブル・どの列にあるか」を横断検索。
  cmdkActionDataSearch: "データ値を検索",
  dataSearchTitle: "データ検索 — {database}",
  dataSearchClose: "閉じる",
  dataSearchNote:
    "対象テーブルを 1 つずつ走査し、すべてのテキスト/数値列で値を検索します。SELECT のみで実行するため、読み取り専用セッションでも安全に使えます。",
  dataSearchLoadingMeta: "テーブル一覧を読み込み中...",
  dataSearchTermLabel: "検索する値",
  dataSearchTermPlaceholder: "値を入力...",
  dataSearchMatchModeLabel: "一致モード",
  dataSearchMatchExact: "完全一致",
  dataSearchMatchContains: "部分一致",
  dataSearchMatchPrefix: "前方一致",
  dataSearchScopeLabel: "スコープ",
  dataSearchScopeAll: "全テーブル",
  dataSearchScopeSelected: "選択したテーブル",
  dataSearchFilterPlaceholder: "テーブルを絞り込み...",
  dataSearchNoFilterMatch: "一致するテーブルがありません",
  dataSearchSelectedCount: "{total} 件中 {selected} 件を選択",
  dataSearchNoSelection: "1 つ以上テーブルを選択してください",
  dataSearchThresholdLabel: "スキップする閾値 (概算行数)",
  dataSearchThresholdHint: "概算行数がこの値を超えるテーブルはスキャンをスキップし、別途一覧表示します。",
  dataSearchEstimateRows: "約 {rows} 行",
  dataSearchEstimateUnknownRows: "約 {rows} 行以上 (一部テーブルの行数は不明)",
  dataSearchSummary: "対象 {count} テーブル ({rows})",
  dataSearchStart: "スキャン開始",
  dataSearchRunning: "スキャン中...",
  dataSearchCancel: "キャンセル",
  dataSearchConfirmTitle: "{count} テーブルをスキャンしますか?",
  dataSearchConfirmBody:
    "{count} テーブル (合計 {rows}) に対して読み取り専用のクエリを実行し、値を検索します。DB が大きい場合は時間がかかることがあります。",
  dataSearchProductionConfirm: "「{name}」は本番接続です。多数のテーブルを走査するとサーバへの読み取り負荷が増えます。続行しますか?",
  dataSearchProgress: "{index}/{total} 走査中 — {table}",
  dataSearchDone: "完了: {hits} テーブルでヒット、{noHits} テーブルはヒットなし、{skipped} 件スキップ",
  dataSearchNoHits: "走査したテーブルに一致する値はありませんでした。",
  dataSearchHitsHeading: "ヒット",
  dataSearchHitCount: "{count} 件ヒット",
  dataSearchOpenTable: "全ヒットを開く",
  dataSearchSkippedHeading: "スキップしたテーブル",
  dataSearchSkipReasonThreshold: "概算行数が閾値を超えています",
  dataSearchSkipReasonNoColumns: "検索対象の列 (テキスト/数値) がありません",
  dataSearchSkipReasonError: "エラー: {error}",
  dataSearchNewSearch: "新しい検索",
  ...
  // `.sql` スクリプト実行 (#973)。
  contextMenuRunScript: "SQL ファイルを実行...",
  scriptTitle: "SQL ファイルを実行",
  scriptTitleDb: "「{database}」で SQL ファイルを実行",
  scriptNote:
    ".sql ファイルを全体をメモリに載せずに 1 文ずつ実行します (ダンプのリストアなど)。読み取り専用プロファイルでは書き込み文はすべて拒否されます。",
  scriptFileLabel: "SQL ファイル",
  scriptFilePlaceholder: "/path/to/script.sql",
  scriptBrowse: "参照…",
  scriptPickFileTitle: "実行する SQL ファイルを選択",
  scriptOptionsLabel: "エラー時の動作",
  scriptOptContinue: "エラーが出ても続行",
  scriptOptContinueHint:
    "失敗した文をスキップして最後まで実行し、失敗した文を一覧で表示します。各文は実行したそばから確定されます。",
  scriptOptWrap: "トランザクションで包む (all-or-nothing)",
  scriptOptWrapHint:
    "ファイル全体を 1 つのトランザクションで実行し、最初のエラーやキャンセルですべて取り消します。ファイル内の BEGIN/COMMIT は読み飛ばします。MySQL/MariaDB では DDL (CREATE/ALTER/DROP など) が暗黙にコミットされるため、DDL を含むスクリプトは原子的になりません。",
  scriptSessionNote:
    "トランザクションなしでは文ごとにプールの別の接続で実行されうるため、セッション設定 (SET …) が後続の文に引き継がれるのはトランザクション内だけです。",
  scriptExecute: "実行",
  scriptRunning: "実行中…",
  scriptCancelRun: "中止",
  scriptClose: "閉じる",
  scriptProgress: "{executed} 文を実行済み",
  scriptProgressFailed: "{failed} 件失敗",
  scriptProgressPercent: "ファイルの {percent}% を読み込み済み",
  scriptDone: "{executed} 文を {secs} 秒で実行しました ({rows} 行に影響)。",
  scriptDonePartial: "{executed} 文を実行しました。{failed} 件が失敗しスキップされました。",
  scriptDoneSkippedControl: "ファイル内の BEGIN/COMMIT {count} 文は読み飛ばしました (ランナーのトランザクションを使用)。",
  scriptFailuresLabel: "失敗した文",
  scriptFailuresOmitted: "…ほか {count} 件",
  scriptFailureLine: "{line} 行目",
  scriptError: "スクリプトを停止しました: {error}",
  scriptErrorAt: "{line} 行目で停止しました: {error}",
  scriptRolledBack: "開いていたトランザクションはロールバックしました。",
  scriptCancelled: "スクリプトを中止しました。確定済みの {count} 文はそのまま残ります。",
  scriptProductionConfirmTitle: "本番接続で実行しますか？",
  scriptProductionConfirmMessage: "この接続は本番としてマークされています。「{file}」を実行しますか？",
  scriptProductionConfirmOk: "実行する",
  // 接続間データ転送 (#986)。
  transferTitle: "別の接続へコピー",
  transferClose: "閉じる",
  transferNote:
    "テーブルまたは結果セットを、スキーマごと別の接続のテーブルへコピーします。行はバッチ単位でストリーミングします。制約・インデックスはコピーしません。",
  transferSourceLabel: "コピー元",
  transferSourceTable: "テーブル {table} (全件)",
  transferSourceQuery: "現在のクエリの結果 (全件を再実行)",
  transferTargetProfile: "コピー先の接続",
  transferSelectProfile: "接続を選択…",
  transferConnectError: "接続できませんでした: {error}",
  transferTargetReadOnly: "この接続は読み取り専用のため、データを書き込めません。",
  transferTargetDatabase: "コピー先のデータベース / スキーマ",
  transferTargetTable: "コピー先のテーブル",
  transferTableExists: "テーブル {table} は既に存在します。「置き換え」か「追記」を選んでください。",
  transferTableMissing: "テーブル {table} が存在しないため追記できません。",
  transferSameTable: "コピー元とコピー先が同じテーブルです。",
  transferModeLabel: "テーブルが既にある場合",
  transferModeCreate: "新規作成 (既にあれば失敗)",
  transferModeReplace: "置き換え (削除して作り直す)",
  transferModeAppend: "既存テーブルへ追記",
  transferModeCreateHint:
    "列の型はコピー先のデータベースに合わせて変換します。失敗・キャンセル時は作成途中のテーブルを削除します。",
  transferModeAppendHint:
    "列は名前で対応付けます。失敗・キャンセルまでに書き込んだ行はテーブルに残ります。",
  transferProgress: "転送中… {rows} 行を書き込みました",
  transferError: "転送に失敗しました: {error}",
  transferCancelRun: "転送を中止",
  transferRunning: "転送中…",
  transferExecute: "転送",
  transferReplaceConfirmTitle: "既存のテーブルを置き換えますか？",
  transferReplaceConfirmBody:
    "{name} のテーブル {table} を削除し、コピー元から作り直します。現在のデータは失われます。",
  transferReplaceConfirmOk: "削除して置き換え",
  transferProductionReplaceBody:
    "{name} は本番接続です。テーブル {table} を削除して作り直すため、現在のデータは失われます。確認のため接続名を入力してください。",
  transferProductionConfirm: "{name} は本番接続です。転送した行を {table} へ書き込みますか？",
  transferDone: "{name} の {table} へ {rows} 行を転送しました。",
  transferCancelled: "転送を中止しました。作成途中のテーブルは削除されます。",
  transferCancelledAppend: "転送を中止しました。{rows} 行は既に追記済みです。",
  transferResultButton: "別接続へ",
  transferResultButtonTitle: "このクエリの全件結果を別の接続のテーブルへコピーします",
  contextMenuTransferTable: "別の接続へコピー...",
  ...
  // 列編集ダイアログ (ALTER TABLE ADD/MODIFY/DROP/RENAME COLUMN・CREATE INDEX、#794)。
  alterTableTitle: "列を編集: {table}",
  alterTableLoading: "列情報を読み込み中...",
  alterTableLoadError: "列情報の読み込みに失敗しました: {error}",
  alterTableExistingSection: "既存の列",
  alterTableMysqlExtraNote:
    "列のリネームや型・NOT NULL・DEFAULT の変更では AUTO_INCREMENT や ON UPDATE は保持されますが、文字セット・照合順序・COMMENT・生成列の式 (このダイアログでは取得していません) は保持されません。",
  alterTableNewName: "新しい名前",
  alterTableDrop: "削除",
  alterTableKeep: "残す",
  alterTableNotNullAria: "{column} の NOT NULL",
  alterTableNotNullNewAria: "新しい列 {n} の NOT NULL",
  alterTableAddedSection: "新しい列",
  alterTableIndexNamePlaceholder: "index_name",
  alterTableAddIndex: "インデックスを追加",
  alterTableRemoveIndex: "インデックスを削除",
  alterTableUnsupportedTitle: "このドライバでは非対応",
  alterTableUnsupportedSqlite:
    "{column}: SQLite は列の型・NOT NULL・DEFAULT をその場で変更できません。データを移送してテーブルを再作成してください。",
  alterTablePreview: "SQL プレビュー",
  alterTablePreviewEmpty: "まだ変更はありません。",
  alterTableRun: "適用",
  alterTableReadOnly: "この接続は読み取り専用のため、列の編集はできません。",
  alterTableConfirmTitle: "{table} にこの変更を適用しますか?",
  alterTableConfirmBody: "以下の文が実行されます:",
  alterTableConfirmOk: "適用",
  alterTableSuccess: "{table} の列を更新しました。",
  // インデックス作成の軽量モーダル (#850)。
  createIndexTitle: "インデックスを作成: {table}",
  createIndexName: "インデックス名",
  createIndexNamePlaceholder: "(空欄なら自動生成)",
  createIndexColumns: "対象列",
  createIndexPreviewEmpty: "列を 1 つ以上選択すると SQL がプレビューされます。",
  createIndexRun: "インデックスを作成",
  ...
  dropConfirmOk: "DROP TABLE",
  // インデックス削除 (#850)。ツリーのインデックスノード右クリックから。
  dropIndexConfirmTitle: "インデックス {index} を DROP しますか?",
  dropIndexConfirmBody: "{table} のインデックス {index} を完全に削除します。この操作は取り消せません。",
  dropIndexConfirmOk: "インデックスを DROP",
  dropIndexSuccess: "インデックス {index} を削除しました。",
  dropIndexPrimaryDisabled: "主キーのインデックスはこの方法では削除できません。",
  ...
  objGroupTables: "テーブル",
  treeColumnsLabel: "列",
  treeForeignKeysLabel: "外部キー",
  treeFkOpenHint: "参照先テーブル {table} を開く",
  explorerContainerDatabase: "データベース",
  explorerContainerSchema: "スキーマ",
  contextMenuOpenData: "データを開く",
  contextMenuOpenStructure: "構造を表示",
  contextMenuShowDefinition: "定義を表示",
  sidebarResizeAria: "サイドバーの幅を変更",
  structureTitle: "構造",
  timelapseTitle: "タイムラプス",
  timelapseMenuLabel: "テーブルをウォッチ (タイムラプス)…",
  timelapseCaptureNow: "今すぐ取得",
  timelapseUsage: "ローカル保存量: {size}",
  timelapseLoadError: "テーブル・タイムラプスを読み込めませんでした: {error}",
  timelapseRetry: "再試行",
  timelapseEmptyTitle: "ウォッチ中のテーブルはありません",
  timelapseEmptyDescription: "スキーマツリーでテーブルを右クリックし「テーブルをウォッチ (タイムラプス)」を選ぶと、世代スナップショットを保存して任意の 2 世代を比較できます。対象はマスターデータ級の小さなテーブル (最大 {limit} 行・主キー必須) で、大きなテーブルの履歴管理は対象外です。",
  timelapseWatchListAria: "ウォッチ中のテーブル",
  timelapseGenerationCount: "{count} 世代",
  timelapseInactive: "解除済み",
  timelapsePartial: "部分取得",
  timelapseUnwatch: "ウォッチ解除",
  timelapseNeedTwo: "差分の表示には異なる 2 世代が必要です。テーブルの内容が変わったとき (接続時または「今すぐ取得」) に新しい世代が保存されます。",
  timelapseFrom: "古い世代",
  timelapseTo: "新しい世代",
  timelapseLatest: "最新",
  timelapseRows: "{count} 行",
  timelapseLatestVsPrevious: "最新 ↔ 1 つ前",
  timelapseDiffError: "差分を計算できませんでした: {error}",
  timelapseCountAdded: "追加: {count}",
  timelapseCountChanged: "変更: {count}",
  timelapseCountRemoved: "削除: {count}",
  timelapsePartialNote: "部分取得の世代が含まれます (主キー順の先頭 {limit} 行のみ)。範囲外の行は追加・削除として表示されることがあります。",
  timelapseColumnsAdded: "追加された列: {columns}",
  timelapseColumnsRemoved: "削除された列 (比較対象外): {columns}",
  timelapseMaskedNote: "機微カラムは表示上だけ伏せ字にしています。スナップショットには実値がローカル保存されています。",
  timelapseNoChanges: "この 2 世代の間に行の差分はありません。",
  timelapseDiffAria: "世代間の行差分",
  timelapseChangeColumn: "変化",
  timelapseKindAdded: "追加",
  timelapseKindRemoved: "削除",
  timelapseKindChanged: "変更",
  timelapseWatchConfirmTitle: "「{table}」をウォッチしますか?",
  timelapseWatchScope: "接続時と「今すぐ取得」でスナップショットを取り、内容が変わったときだけ新しい世代として保存します。対象はマスターデータ・設定値などの小さなテーブル (最大 {limit} 行) で、大きなテーブルの履歴管理は対象外です。",
  timelapseWatchPk: "主キーのあるテーブルに限ります (世代間で行を追跡するために使います)。",
  timelapseWatchPrivacy: "スナップショットは実データのローカルコピーで、機微なデータを含む可能性があります。保存先はこの端末のアプリデータディレクトリ (table_timelapse.sqlite) のみで、外部へは一切送信しません。ウォッチ解除時や設定画面から削除できます。",
  timelapseWatchMask: "機微カラムのマスクは表示だけに適用され、保存データはマスクされません。取得は読み取り専用の SELECT で、クエリ履歴にも記録しません。",
  timelapseWatchConfirmOk: "ウォッチを開始",
  timelapseOverLimitTitle: "このテーブルは {limit} 行を超えています",
  timelapseOverLimitMessage: "記録できるのは主キー順の先頭 {limit} 行だけです。範囲外の変更は検出できません。先頭 {limit} 行だけを記録しますか?",
  timelapseOverLimitOk: "先頭 {limit} 行を記録",
  timelapseWatchDeclined: "{limit} 行を超えるためウォッチしませんでした。",
  timelapseWatched: "{table} のウォッチを開始しました。",
  timelapseCaptureChanged: "新しい世代を保存しました: {tables}",
  timelapseCaptureUnchanged: "前回の世代から変化はありません。",
  timelapseUnwatchTitle: "「{table}」のウォッチを解除しますか?",
  timelapseUnwatchMessage: "このテーブルの自動スナップショットを停止します。",
  timelapseDeleteDataTitle: "保存済みの世代を削除しますか?",
  timelapseDeleteDataMessage: "{table} の保存済み世代が {count} 件この端末に残っています。削除しますか? 残しておくと後から閲覧できます。",
  timelapseDeleteDataOk: "データを削除",
  timelapseKeepData: "データを残す",
  timelapseCaptureChangedToast: "テーブル・タイムラプス: 内容が変化しました — {tables}",
  timelapseCaptureFailedToast: "テーブル・タイムラプス: スナップショットを取得できませんでした — {tables}",
  settingsTimelapse: "テーブル・タイムラプス",
  settingsTimelapseHelp: "ウォッチ登録したテーブルの世代スナップショットを、アプリデータディレクトリ配下のローカル専用ストアに保存します。スナップショットは実データのコピーで、外部へは送信しません。",
  settingsTimelapseOnConnect: "接続時にウォッチ中のテーブルを取得",
  settingsTimelapseOnConnectHelp: "接続直後に、ウォッチ中のテーブルごとに読み取り専用の SELECT を 1 回実行します (履歴には記録しません)。",
  settingsTimelapseMaxGenerations: "テーブルごとの保持世代数",
  settingsTimelapseMaxGenerationsHelp: "古い世代から削除します。全体の保存量も 64 MiB で頭打ちになります。",
  settingsTimelapseClearAll: "タイムラプスのデータをすべて削除",
  settingsTimelapseClearTitle: "テーブル・タイムラプスのデータをすべて削除しますか?",
  settingsTimelapseClearMessage: "すべての接続のウォッチ登録と保存済み世代をこの端末から削除します。元に戻せません。",
  settingsTimelapseCleared: "保存済みの世代を {count} 件削除しました。",
  structureOpenData: "データを開く",
  structureReload: "再読み込み",
  structureLoading: "テーブル構造を読み込んでいます…",
  structureLoadError: "テーブル構造を取得できませんでした: {error}",
  structureColumns: "列",
  structureColName: "列",
  structureColType: "型",
  structureColNullable: "NULL 許容",
  structureColDefault: "既定値",
  structureColKeys: "キー",
  structureNullableYes: "NULL",
  structureNullableNo: "NOT NULL",
  structureKeyFk: "FK",
  structureOpenReferencedHint: "参照先テーブルの構造を表示",
  structureIndexName: "インデックス",
  structureIndexColumns: "列",
  structureIndexKind: "種別",
  structureNoIndexes: "インデックスはありません。",
  structureForeignKeys: "外部キー",
  structureNoForeignKeys: "外部キーはありません。",
  structureFkReferences: "参照先",
  cmdkFocusExplorer: "Database Explorer を絞り込む",
  cmdkTableStructure: "構造: {table}",
  treeLoading: "読み込み中...",
  ...
  colTipExtra: "追加情報",
  colTipComment: "コメント",
  alterTableTableComment: "テーブルコメント",
  alterTableCommentPlaceholder: "このテーブルの用途・中身の説明",
  alterTableCommentUnsupported: "SQLite はテーブル / カラムのコメント機能を持たないため、表示・編集できません。",
  alterTableColComment: "コメント",
  alterTableColCommentAria: "カラム {column} のコメント",
  colPkTitle: "主キー",
  ...
  gridSearchPlaceholder: "全カラムを絞り込み...",
  gridSearchAria: "全カラム横断絞り込み",
  gridFindAria: "結果内検索",
  gridFindInputAria: "結果内検索クエリ",
  gridFindPlaceholder: "結果内を検索...",
  gridFindCaseTitle: "大文字と小文字を区別",
  gridFindWholeTitle: "セル値と完全一致",
  gridFindRegexTitle: "正規表現",
  gridFindCount: "{total} 件中 {current} 件目",
  gridFindNoHits: "一致なし",
  gridFindInvalidRegex: "正規表現が不正です",
  gridFindPrevTitle: "前のヒット (Shift+Enter)",
  gridFindNextTitle: "次のヒット (Enter)",
  gridFindCloseTitle: "検索を閉じる (Esc)",
  gridSortAsc: "昇順で並び替え",
  ...
  gridNullBarAria: "{column}: 取得済み {count} 行のうち {percent}% が NULL",
  gridStatsFullButton: "全件集計",
  gridStatsFullSection: "全件",
  gridStatsLoading: "集計中…",
  gridStatsError: "集計に失敗しました",
  gridStatsClose: "閉じる",
  gridFooterLabel: "集計フッター",
  gridFooterShow: "集計フッターを表示",
  gridFooterHide: "集計フッターを隠す",
  gridFooterFnNone: "なし",
  gridFooterAria: "集計フッター行",
  gridFooterSelectAria: "{column} の集計フッター関数",
  gridStopButton: "停止",
  ...
  gridQuickFilterTitleServer:
    "サーバ側の WHERE として全件に適用します。値の除外では NULL の行も落ちます (SQL の三値論理)。",
  gridQuickFilterTitleClient:
  ...
  valuePickerSet: "SET",
  valuePickerCheck: "CHECK",
  valuePickerTitleFk: "{target} の既存値を候補に出します (前方一致・最大 {limit} 件)。自由入力もできます。",
  valuePickerTitleAllowed: "列の型または CHECK 制約が許す値を候補に出します。自由入力もできます。",
  ...
  cellViewerSave: "保存",
  cellViewerCancel: "取消",
  cellViewerSetNull: "NULL に設定",
  cellViewerFormat: "整形",
  cellViewerMinify: "最小化",
  cellViewerInvalidJson: "JSON が不正です — 保存前に修正してください。",
  cellViewerViewMode: "表示形式",
  cellViewerViewTree: "ツリー",
  cellViewerViewText: "テキスト",
  jsonTreeAria: "JSON ツリー",
  jsonTreeSearchPlaceholder: "キー・値を検索",
  jsonTreeSearchCount: "{count} 件一致",
  jsonTreeSearchTruncated: "先頭 {count} 件まで表示 (打ち切り)",
  jsonTreeNoMatches: "一致するキー・値はありません",
  jsonTreeKeys: "{n} キー",
  jsonTreeItems: "{n} 件",
  jsonTreeShowMore: "さらに {n} 件表示",
  jsonTreeSelectHint: "ノードを選択するとパスや SQL をコピーできます。",
  jsonTreeCopyPath: "パスをコピー",
  jsonTreeCopyValue: "値をコピー",
  jsonTreeCopySqlExpr: "SQL 抽出式をコピー",
  jsonTreeCopySqlWhere: "WHERE 条件をコピー",
  jsonTreeCopied: "クリップボードにコピーしました",
  ...
  contextMenuGenerateTestData: "テストデータを生成...",
  ...
  // ファイルから新規テーブルを作成 (#985)。
  importNewTableTitle: "ファイルを新規テーブルとしてインポート",
  importCreateNewTable: "新規テーブルを作成",
  importNewTableName: "新しいテーブル名",
  importNewTableColumns: "列 (名前 / 型)",
  importNewTableHint:
    "型はプレビュー行 (最大 50 行) から推論しています。合っていない列は型を上書きしてください。DB が持たない型は方言ごとに縮退します (例: SQLite の日付は TEXT)。",
  importNewTableInferred: "推論: {type}",
  importNewTableInclude: "列 {name} を取り込む",
  importNewTableColumnName: "フィールド {n} の列名",
  importNewTableColumnType: "列 {name} の型",
  importNewTableDdl: "CREATE TABLE のプレビュー",
  importNewTableAbortHint:
    "「失敗時は全体を中止」で取り込みに失敗した場合、作成したテーブルは削除されます。途中で中止した場合は (空の) テーブルが残ります。",
  importNewTableNameRequired: "テーブル名を入力してください。",
  importNewTableNameWhitespace: "名前の前後に空白は使えません: 「{name}」",
  importNewTableNameTooLong: "「{name}」はこの DB の上限 {limit} 文字を超えています。",
  importNewTableNoColumns: "取り込む列を 1 つ以上選んでください。",
  importNewTableColumnNameRequired: "取り込む列にはすべて名前が必要です。",
  importNewTableDuplicateColumn: "列名が重複しています (大文字小文字を区別しません): {name}",
  importNewTableCreated: "テーブル {table} を作成しました。",
  importTypeInteger: "整数",
  importTypeBigint: "整数 (64bit)",
  importTypeDecimal: "固定小数",
  importTypeDouble: "浮動小数",
  importTypeBoolean: "真偽値",
  importTypeDate: "日付",
  importTypeDatetime: "日時",
  importTypeText: "文字列",
  contextMenuImportNewTable: "ファイルから新規テーブル...",

  // スキーマに基づくテストデータ生成 (#602)
  testDataTitle: "{table} にテストデータを生成",
  testDataClose: "閉じる",
  testDataHint:
    "テーブルのスキーマからダミー行を生成し、単一のトランザクションで all-or-nothing 投入します。既定の生成方針はカラム型から推定され、外部キーは参照先の既存値から選びます。同じシードなら常に同じ行が生成されます。",
  testDataRowCount: "行数",
  testDataRowCountInvalid: "1〜{max} の行数を入力してください。",
  testDataSeed: "シード",
  testDataReseed: "シード再生成",
  testDataLoading: "テーブル定義を読み込み中...",
  testDataColumnsTitle: "カラム別の生成方針",
  testDataStrategyAria: "カラム {column} の生成方針",
  testDataStrategySerial: "連番",
  testDataStrategyUuid: "UUID",
  testDataStrategyRandomNumber: "ランダム数値",
  testDataStrategyRandomString: "ランダム文字列",
  testDataStrategyRandomDate: "ランダム日時",
  testDataStrategyRandomBool: "ランダム真偽",
  testDataStrategyFixed: "固定値",
  testDataStrategyChoice: "列挙からランダム",
  testDataStrategyFkRef: "参照先の既存値からランダム",
  testDataStrategyOmit: "投入しない (DB 既定値)",
  testDataFixedValue: "値",
  testDataSerialStart: "開始値",
  testDataLength: "文字数",
  testDataMin: "最小",
  testDataMax: "最大",
  testDataNullRate: "NULL %",
  testDataNullRateAria: "カラム {column} の NULL 率 (%)",
  testDataFkSource: "{table}.{column} から ({count} 件)",
  testDataFkEmpty:
    "参照先の値が見つかりません: {columns}。これらのカラムは NULL になります — 先に参照先テーブルへ行を投入してください。",
  testDataNoColumns: "すべてのカラムが対象外です — 投入する値がありません。",
  testDataPreviewTitle: "プレビュー (先頭 {count} 行)",
  testDataRunningStatus: "{count} 行を投入中...",
  testDataRun: "投入",
  testDataRunning: "投入中...",
  testDataSuccess: "{table} にテストデータ {count} 行を投入しました ({ms} ms)。",
  testDataProductionConfirmTitle: "{table} にテストデータを投入しますか?",
  testDataProductionConfirmBody:
    "この接続は本番として設定されています。生成した {count} 行が {table} に書き込まれます。この操作は簡単には取り消せません。",
  ...
  helpShortcutSearchTitle: "Cmd/Ctrl+F",
  helpShortcutSearchDesc: "結果内検索バーを開き、取得済み行を横断してヒットセルをハイライトします。",
  shortcutFindNavTitle: "Enter / Shift+Enter (検索バー内)",
  shortcutFindNavDesc: "次 / 前のヒットへ移動します。Esc でバーを閉じてグリッドへフォーカスを戻します。",
  ...
  resultRestoreTitle: "結果パネルを元に戻す（Esc / Cmd/Ctrl+Shift+M）",
  resultMaximizedLabel: "結果（最大化表示）",
  shortcutFocusEditorTitle: "Cmd/Ctrl+Shift+E",
  shortcutFocusEditorDesc: "エディタ集中モード（エディタの最大化）を切り替えます。",
  editorFocusTitle: "エディタに集中（Cmd/Ctrl+Shift+E）",
  editorRestoreTitle: "レイアウトを元に戻す（Esc / Cmd/Ctrl+Shift+E）",
  editorFocusedLabel: "エディタ（集中表示）",
  helpShortcutNewTabTitle: "Cmd/Ctrl+T",
  ...
  appSchemaDrift: "スキーマドリフト・タイムライン",
  appSchemaDriftUnsupported: "既定データベースを選択して接続してください",
  appPinCompare: "ピン留め結果を比較 ({count})",
  pinResultTitle: "この結果を比較用にピン留め",
  pinCompareTitle: "ピン留め結果の比較",
  pinCompareEmpty: "ピン留めした結果がありません。結果のピンボタンで保持できます。",
  pinCompareEmptyHint: "先に結果をピン留めしてください (結果ツールバーのピンボタン)",
  pinCompareSelect: "ここに表示するピン留め結果を選択してください。",
  pinCompareLeft: "左",
  pinCompareRight: "右",
  pinCompareKeyColumn: "キー列",
  pinCompareDiff: "行差分をハイライト",
  pinCompareNotComparable: "カラム構成が異なるため行差分は表示できません",
  pinCompareUnpin: "右をピン解除",
  pinCompareClearAll: "すべて消去",
  pinCompareClose: "閉じる",

  // 環境横断ブロードキャスト実行 (#738)
  editorBroadcast: "複数の接続で実行",
  editorBroadcastTitle: "この読み取り専用クエリを複数の接続へ一斉実行し、結果を比較します。",
  broadcastDisabledSingle: "ブロードキャストするには、同じドライバでもう 1 つ接続を開いてください。",
  broadcastBlockedToast: "ブロードキャスト実行は読み取り専用の文のみ許可されます。",
  broadcastPickerTitle: "複数の接続で実行",
  broadcastPickerReadOnlyNotice: "読み取りクエリ限定です — 書き込み文は常に拒否されます。",
  broadcastBaselineLabel: "基準",
  broadcastPickerEmpty: "現在の接続と同じドライバの接続が他にありません。",
  broadcastPickerCancel: "キャンセル",
  broadcastPickerRun: "実行",
  broadcastProductionConfirmTitle: "本番接続が含まれています",
  broadcastProductionConfirmMessage: "この一斉実行には本番接続が含まれます: {names}。続行しますか?",
  broadcastProductionConfirmAction: "続行する",
  broadcastResultsTitle: "ブロードキャスト実行結果",
  broadcastClose: "閉じる",
  broadcastCancelAll: "すべてキャンセル",
  broadcastCancelEntry: "この接続をキャンセル",
  broadcastKeyColumnLabel: "キー列 (行差分用)",
  broadcastKeyColumnNone: "なし — 行ハッシュで比較",
  broadcastStatusRunning: "実行中…",
  broadcastStatusDone: "完了",
  broadcastStatusError: "エラー",
  broadcastStatusCancelled: "キャンセル済み",
  broadcastRowCount: "{rows} 行",
  broadcastErrorLabel: "エラー: {error}",
  broadcastDiffNone: "差分なし",
  broadcastDiffPk: "変更 {changed} セル、追加 +{added}、欠落 -{removed}",
  broadcastDiffHash: "追加 +{added}、欠落 -{removed} (PK 不明のため追加/欠落のみの簡易比較)",
  broadcastDiffIncomparable: "基準環境とカラム構成が異なるため比較できません",
  broadcastDiffTruncated: "先頭 {max} 行のみ比較しました",
  broadcastDiffPending: "基準環境とこの接続の両方が完了するのを待っています…",
  ...
  erDiagramLayout: "レイアウト",
  erDiagramLayoutLR: "左 → 右",
  erDiagramLayoutTB: "上 → 下",
  erDiagramDensity: "間隔",
  erDiagramDensityComfortable: "標準",
  erDiagramDensityCompact: "密",
  ...
  // マイグレーションファイルとしての保存 (#744)
  schemaCompareSaveMigration: "マイグレーションとして保存...",
  schemaCompareMigrationTitle: "マイグレーションファイルとして保存",
  schemaCompareMigrationDesc:
    "同期プランを Flyway / golang-migrate / sqlx / 汎用形式の up/down マイグレーションファイルとして書き出します。up ファイルはすでに生成済みのプランをそのまま使い、down ファイルはソース/ターゲットを入れ替えて比較し直した新しいプランから生成します。ローカルにファイルを書き出すだけで、どちらのデータベースにも一切適用されません。",
  schemaCompareMigrationFormat: "フォーマット",
  schemaCompareMigrationFormatFlyway: "Flyway (V/U プレフィックス)",
  schemaCompareMigrationFormatGolangMigrate: "golang-migrate (.up/.down)",
  schemaCompareMigrationFormatSqlx: "sqlx (-r、.up/.down)",
  schemaCompareMigrationFormatGeneric: "汎用 (.up/.down)",
  schemaCompareMigrationName: "マイグレーション名",
  schemaCompareMigrationNameHint: "保存名: {name}",
  schemaCompareMigrationFiles: "ファイル名",
  schemaCompareMigrationLoadingDown: "down マイグレーションを生成中 (入れ替えて再比較しています)...",
  schemaCompareMigrationDownError: "down マイグレーションの生成に失敗しました: {error}",
  schemaCompareMigrationSummary:
    "up: {upCount} 文 · down: {downCount} 文 · 警告 {warnings} 件 (SQL コメントとして記録)",
  schemaCompareMigrationSaveTitle: "マイグレーションファイルを保存",
  schemaCompareMigrationCancel: "キャンセル",
  schemaCompareMigrationSave: "保存",
  schemaCompareMigrationSaving: "保存中...",
  schemaCompareMigrationSaved: "保存しました:\nup:   {up}\ndown: {down}",
  schemaCompareMigrationError: "マイグレーションファイルの保存に失敗しました: {error}",
  ...
  // ユーザ / 権限管理パネル (#732)
  usersTitle: "ユーザ / 権限管理",
  usersClose: "ユーザ / 権限管理を閉じる",
  usersDesc:
    "MySQL アカウント (mysql.user) / PostgreSQL ロール (pg_roles) の一覧です。ユーザ/ロールを選択すると、テーブル単位の権限マトリクス (SELECT/INSERT/UPDATE/DELETE/DDL) を閲覧・編集できます。変更はすべてスキーマ同期と同じ「SQL 生成 → プレビュー → 確認 → 適用」のフローを通ります。",
  usersRefresh: "更新",
  usersRetry: "再試行",
  usersLoadError: "ユーザ一覧の取得に失敗しました: {error}",
  usersEmpty: "表示するユーザがありません。",
  usersReadOnlyHint: "読み取り専用セッションのため、ユーザ / 権限の変更は無効です (バックエンドで強制されます)。",
  usersSelectUserHint: "ユーザ/ロールを選択すると権限を表示します。",
  usersSuperuserBadge: "SUPERUSER",
  usersNewUser: "新規ユーザ…",
  usersCreateNameLabel: "名前",
  usersCreateHostLabel: "ホスト (MySQL アカウントのホストパターン。例: %, localhost)",
  usersCreatePasswordLabel: "パスワード (任意)",
  usersCreateCancel: "キャンセル",
  usersCreateSubmit: "作成",
  usersCreateConfirmTitle: "ユーザを作成",
  usersCreateConfirmMessage: "以下の SQL を実行します:",
  usersCreateConfirmOk: "作成",
  usersCreateDone: "ユーザ {name} を作成しました",
  usersCreateFailed: "ユーザの作成に失敗しました: {error}",
  usersChangePassword: "パスワード変更…",
  usersPasswordLabel: "新しいパスワード",
  usersPasswordCancel: "キャンセル",
  usersPasswordSubmit: "変更",
  usersPasswordConfirmTitle: "パスワードを変更",
  usersPasswordConfirmMessage: "以下の SQL で {name} のパスワードを変更します:",
  usersPasswordConfirmOk: "パスワードを変更",
  usersPasswordDone: "パスワードを変更しました",
  usersPasswordFailed: "パスワードの変更に失敗しました: {error}",
  usersDropUser: "ユーザを削除",
  usersDropConfirmTitle: "ユーザを削除",
  usersDropConfirmMessage: "{name} を完全に削除します。この操作は取り消せません。",
  usersDropConfirmOk: "削除",
  usersDropDone: "ユーザ {name} を削除しました",
  usersDropFailed: "ユーザの削除に失敗しました: {error}",
  usersGlobalRowHint:
    "mysql.user のサーバ全体 (グローバル) 権限です。参照専用 — このパネルが編集するのは選択中データベース内のテーブル単位権限で、GRANT ... ON *.* によるグローバル権限とはスコープが異なります。",
  usersNeedDatabaseHint: "テーブル単位の権限を表示・編集するには、データベースを開いてください。",
  usersPrivilegesLoadError: "権限の取得に失敗しました: {error}",
  usersPrivilegesEmpty: "選択中データベースにテーブル単位の GRANT がありません。下のフォームからテーブルを追加して権限を付与できます。",
  usersColTable: "テーブル",
  usersColSelect: "SELECT",
  usersColInsert: "INSERT",
  usersColUpdate: "UPDATE",
  ...
  usersColDdl: "DDL",
  usersColDdlHint:
    "各ドライバがテーブル単位で GRANT できるスキーマ変更系権限をまとめたものです — MySQL: CREATE, ALTER, DROP, INDEX, REFERENCES。PostgreSQL: TRUNCATE, REFERENCES, TRIGGER。",
  usersAddTablePlaceholder: "テーブル名",
  usersAddTableButton: "テーブルを追加",
  usersDiscardChanges: "変更を破棄",
  usersApplyChanges: "変更を適用",
  usersApplyConfirmTitle: "権限変更を適用",
  usersApplyConfirmMessage: "以下の {count} 件の SQL 文を実行します:",
  usersApplyConfirmOk: "適用",
  usersApplyDone: "権限変更を適用しました",
  usersApplyFailed: "権限変更の適用に失敗しました: {error}",
  usersNoChanges: "適用する変更がありません。",

  // 監視ダッシュボード (#731)
  processTabProcesses: "プロセス一覧",
  processTabMetrics: "メトリクス",
  metricsDesc:
  ...
  metricsChartProblems: "ロック待ち・スロークエリ",
  metricsCountUnit: "件",
  metricsQpsUnit: "クエリ/秒",
  metricsTpsUnit: "トランザクション/秒",
  metricsPerSecUnit: "イベント/秒",
  metricsSeriesConnections: "接続数",
  metricsSeriesActive: "実行中",
  metricsSeriesIdleInTx: "アイドル (トランザクション中)",
  metricsSeriesLockWaiting: "ロック待ち",
  metricsSeriesThroughput: "スループット",
  metricsSeriesLockWaitRate: "ロック待ち/秒",
  metricsSeriesSlowQueryRate: "スロークエリ/秒",
  ...
  // データ品質アサーション (#742)
  assertTitle: "データ品質",
  appAssertions: "データ品質アサーション",
  cmdkAssertions: "データ品質アサーション (期待値の一括検証)",
  assertDesc:
    "DB 制約として表現されていない業務上の期待 (NULL なし・一意・値のリスト・値域・孤児行・行数) をルールとして登録し、一括で検証します。検証はすべて読み取り専用の SELECT で、読み取り専用接続でも動き、ルールごとにクエリタイムアウトが効き、クエリ履歴には残りません。",
  assertRunAll: "すべて検証",
  assertCancelRun: "中止",
  assertAdd: "アサーションを追加",
  assertSummary: "成功 {passed}・失敗 {failed}・エラー {errored} (全 {total} 件)",
  assertLoadError: "アサーションを読み込めませんでした: {error}",
  assertRetry: "再試行",
  assertEmptyTitle: "この接続のアサーションはまだありません",
  assertEmptyDesc: "「email は NULL にならない」「status は active / banned のどれか」のようなルールを追加してください。",
  assertColStatus: "状態",
  assertColName: "名前",
  assertColRule: "ルール",
  assertColResult: "結果",
  assertStatusPass: "成功",
  assertStatusFail: "失敗",
  assertStatusError: "エラー",
  assertStatusCancelled: "中止",
  assertStatusPending: "未実行",
  assertShowViolations: "違反行を表示",
  assertRunOne: "このアサーションを検証",
  assertEdit: "編集",
  assertDelete: "削除",
  assertDeleteTitle: "アサーションの削除",
  assertDeleteMessage: "アサーション「{name}」を削除しますか? 元に戻せません。",
  assertDeleteError: "アサーションを削除できませんでした: {error}",
  assertSaved: "アサーションを保存しました",
  assertObservedViolations: "違反 {count} 件",
  assertObservedRows: "{count} 行",
  assertRuleNotNull: "NULL なし",
  assertRuleUnique: "一意",
  assertRuleAcceptedValues: "値のリスト",
  assertRuleRange: "値域",
  assertRuleReferential: "参照整合",
  assertRuleRowCount: "行数",
  assertDescNotNull: "{table}.{column} IS NOT NULL",
  assertDescUnique: "{table} ({columns}) が一意",
  assertDescAcceptedValues: "{table}.{column} ∈ {values}",
  assertDescRange: "{min} ≤ {table}.{column} ≤ {max}",
  assertDescReferential: "{table} ({columns}) → {target} ({refColumns})",
  assertDescRowCount: "{table} の行数 {op} {value}",
  assertDescRowCountBetween: "{min} ≤ {table} の行数 ≤ {max}",
  assertAddTitle: "データ品質アサーションの追加",
  assertEditTitle: "データ品質アサーションの編集",
  assertCancel: "キャンセル",
  assertSave: "保存",
  assertSaveError: "保存できませんでした: {error}",
  assertFieldName: "名前",
  assertFieldNamePlaceholder: "例: users.email は必須",
  assertFieldScope: "表示する接続",
  assertScopeProfile: "この接続",
  assertScopeGroup: "この接続のグループ",
  assertScopeAny: "すべての接続",
  assertFieldSchema: "スキーマ",
  assertFieldSchemaPlaceholder: "(セッションの既定)",
  assertFieldTable: "テーブル",
  assertFieldRule: "ルール",
  assertFieldColumn: "列",
  assertFieldColumns: "列",
  assertFieldColumnsPlaceholder: "col_a, col_b",
  assertFieldValues: "許可する値 (1 行に 1 つ)",
  assertFieldValuesPlaceholder: "active\nbanned",
  assertFieldMin: "最小 (含む)",
  assertFieldMax: "最大 (含む)",
  assertFieldBoundPlaceholder: "数値または日付。空欄 = 制限なし",
  assertFieldRefSchema: "参照先スキーマ",
  assertFieldRefTable: "参照先テーブル",
  assertFieldRefColumns: "参照先の列",
  assertFieldOp: "条件",
  assertOpBetween: "範囲",
  assertFieldCount: "行数",
  assertPreviewCheck: "検証クエリ (読み取り専用)",
  assertPreviewViolations: "違反行クエリ (新規タブで開く)",
  assertPreviewEmpty: "ルールを入力すると生成される SQL を表示します。",
  assertErrName: "名前を入力してください。",
  assertErrTable: "テーブルを入力してください。",
  assertErrColumn: "列を入力してください。",
  assertErrColumns: "列を 1 つ以上入力してください。",
  assertErrValues: "許可する値を 1 つ以上入力してください。",
  assertErrBounds: "最小・最大のどちらか (または両方) を入力してください。",
  assertErrRefTable: "参照先テーブルを入力してください。",
  assertErrRefColumns: "参照先の列を参照元の列と同じ数だけ入力してください。",
  assertErrCount: "0 以上の整数を入力してください。",
  assertErrCountMax: "最小以上の最大を入力してください。",
  assertErrScopeGroup: "この接続にはグループがありません。別の表示範囲を選んでください。",
  ...
  // 列データプロファイル (#974)
  profileTitle: "列を探索",
  profileMenuLabel: "列を探索…",
  profileExploreColumn: "列を探索…",
  profileDesc:
    "取得済みの行ではなくテーブル全体をサーバ側で集計します: NULL 率・DISTINCT 数・MIN / MAX・上位頻出値、数値列ならヒストグラム。実行するのは読み取りの SELECT だけです。",
  profileColumnLabel: "列",
  profileSelectColumn: "列を選択",
  profileApproximate: "DISTINCT を近似 (高速)",
  profileApproximateHint:
    "PostgreSQL はプランナの統計情報、DuckDB は approx_count_distinct を使い、正確な COUNT(DISTINCT) を避けます。それ以外のドライバは常に正確値です。",
  profileRun: "プロファイル",
  profileRerun: "再実行",
  profileRunning: "テーブル全体を集計中…",
  profileError: "プロファイルに失敗しました: {error}",
  profileRetry: "再試行",
  profileLoadColumnsError: "列を取得できませんでした: {error}",
  profileEmpty: "列を選んでプロファイルを実行してください",
  profileTotal: "行数",
  profileNulls: "NULL",
  profileDistinct: "DISTINCT",
  profileMin: "最小",
  profileMax: "最大",
  profileType: "型",
  profileApproxMark: "≈ 近似値",
  profileHistogram: "ヒストグラム",
  profileTopValues: "上位頻出値",
  profileValue: "値",
  profileCount: "件数",
  profileShare: "割合",
  profileNoValues: "NULL 以外の値がありません",
  profileNoteStatsUnavailable:
    "この列の型ではサーバが DISTINCT / MIN / MAX を計算できないため、件数だけを表示しています。",
  profileNoteTopUnavailable: "この列の型はグループ化できないため、上位頻出値は表示できません。",
  profileNoteHistogramUnavailable: "この列のヒストグラムは計算できませんでした。",
  profileNoteApproxUnsupported: "このドライバでは近似 DISTINCT を使えないため、正確値を表示しています。",
  profileNoteApproxNoStats:
    "この列の統計情報がまだありません (ANALYZE で収集されます)。正確な DISTINCT 数を表示しています。",
  profileNoteUnknown: "プロファイルの一部を計算できませんでした。",
  ...
  // テーブル保守コマンド (#561)
  maintenanceMenu: "保守",
  maintenanceAnalyze: "ANALYZE (統計更新)",
  maintenanceOptimize: "OPTIMIZE (再構築・最適化)",
  maintenanceCheck: "CHECK (整合性チェック)",
  maintenanceRepair: "REPAIR (修復)",
  ...
  maintenanceConfirmOk: "実行",
  maintenanceReadOnlyTitle: "読み取り専用セッションでは無効です",
  maintenanceDone: "{target} の保守が完了しました",
  maintenanceFailed: "保守の実行に失敗しました: {error}",

  // テーブル/DB サイズ・統計ダッシュボード (#562 / #660)
  sizeTitle: "サイズ・統計",
  sizeClose: "サイズダッシュボードを閉じる",
  sizeDesc:
  ...
  sizePkYes: "有",
  sizePkNo: "無",
  sizeFilterName: "テーブル名で絞り込み…",
  sizeFilterNoIndex: "インデックス無し",
  sizeFilterNoPk: "PK 無し",
  sizeFilterCount: "{total} 件中 {shown} 件",
  sizeNoMatch: "フィルタに一致するテーブルがありません。",
  sizeOpenTable: "テーブル {table} を開く",
  sizeTotalsLabel: "合計 ({count} テーブル)",
  sizeLoadError: "サイズの取得に失敗しました: {error}",
  sizeEmpty: "表示するテーブルがありません。",
  sizeMenuLabel: "サイズ・統計…",

  // サーバ / 接続情報パネル (#563)
  serverInfoTitle: "サーバ情報",
  serverInfoClose: "サーバ情報を閉じる",
  serverInfoDesc:
  ...
  serverInfoColValue: "値",
  serverInfoVarCount: "{total} 件中 {shown} 件の変数",
  serverInfoLoadError: "サーバ情報の取得に失敗しました: {error}",
  serverInfoEmpty: "検索に一致する変数がありません。",
  serverInfoMenuLabel: "サーバ情報…",
  ...
  taskManagerClose: "閉じる",
  taskCreate: "新規タスク",
  taskNoProfiles: "タスクを作成するには、先に接続プロファイルを追加してください。",
  taskLoadError: "タスクの取得に失敗しました: {error}",
  taskRetry: "再試行",
  taskEmpty: "タスクはまだありません。",
  taskToggleEnabled: "「{name}」の有効/無効を切り替え",
  taskNextRun: "次回実行",
  taskDisabled: "無効",
  taskLastOk: "前回: 成功",
  taskLastError: "前回: 失敗",
  ...
  taskEdit: "編集",
  taskDelete: "削除",
  taskHistoryEmpty: "実行履歴はまだありません。",
  taskHistoryClear: "実行履歴を消去",
  taskHistoryClearConfirm: "タスク「{name}」の実行履歴をすべて削除しますか? この操作は取り消せません。",
  taskRunCatchUp: "追い掛け実行",
  taskRunRows: "{rows} 行",
  taskRunBytes: "{bytes} バイト",
  taskDeleteConfirmTitle: "タスクを削除しますか?",
  taskDeleteConfirmMessage: "タスク「{name}」を削除しますか? 実行履歴も削除されます。",
  taskDeleteConfirmOk: "削除",
  taskDeleted: "タスク「{name}」を削除しました。",
  taskRunOk: "「{name}」が正常に完了しました。",
  taskRunFailed: "「{name}」が失敗しました: {error}",
  taskRunNotifyTitle: "タスクが失敗しました: {name}",
  taskFormName: "名前",
  taskFormProfile: "接続",
  taskFormProductionBadge: "本番",
  taskFormActionKind: "アクション",
  taskFormActionExport: "クエリ実行 → ファイルへエクスポート",
  taskFormActionDump: "データベースダンプ",
  taskFormSql: "SQL (読み取り専用のみ)",
  taskFormSqlRequired: "SQL 文を入力してください。",
  taskFormSqlNotReadOnly:
    "タスクで実行できるのは読み取り専用の文のみです (SELECT / SHOW / DESCRIBE / EXPLAIN / WITH)。",
  taskFormDatabaseOptional: "データベース (任意)",
  taskFormDatabase: "データベース",
  taskFormDatabaseRequired: "データベース名を入力してください。",
  taskFormOutputPath: "出力先パス",
  taskFormOutputPathPlaceholder: "例: sales-{date}.csv",
  taskFormOutputPathHint:
    "実行時に {date} は YYYY-MM-DD、{datetime} は YYYYMMDD-HHMMSS (UTC) に展開されます。",
  taskFormOutputPathPreview: "プレビュー: {path}",
  taskFormOutputPathRequired: "出力先パスを入力してください。",
  taskFormSchedule: "スケジュール",
  taskScheduleInterval: "N 分ごと",
  taskScheduleDaily: "毎日",
  taskScheduleMinutes: "分",
  taskScheduleUtcHint: "(UTC)",
  taskFormEnabled: "有効",
  taskFormCancel: "キャンセル",
  taskFormSave: "保存",
  taskFormNameRequired: "タスク名を入力してください。",
  taskFormProfileRequired: "接続を選択してください。",
  taskProductionConfirmTitle: "本番接続にタスクをスケジュールしますか?",
  taskProductionConfirmMessage:
    "「{name}」は本番接続としてマークされています。このタスクはアプリ起動中、自動的に実行され続けます。続けますか?",
  taskProductionConfirmOk: "続ける",
  taskSaved: "タスク「{name}」を保存しました。",
  taskOutputPathBrowseTitle: "出力先ファイルを選択",
  taskCatchUpMissed: "アプリが閉じている間に過ぎたスケジュールを、次回起動時に 1 回だけ追い掛け実行する",
  helpTaskSchedulerTitle: "タスクスケジューラ",
  helpTaskSchedulerDesc:
  ...
  // --- SQL Editor / Result Grid UX (#1113) ---
  shortcutExplainTitle: "Cmd/Ctrl+E",
  shortcutExplainDesc: "選択範囲 (無ければエディタ全体) の実行計画 (EXPLAIN) を表示します。",
  editorMenuRunAll: "クエリを実行",
  editorMenuRunSelection: "選択範囲を実行",
  editorMenuExplainRun: "EXPLAIN を実行",
  editorMenuRunStatement: "カーソル位置の文を実行",
  editorMenuPreview: "Dry Run (プレビュー)",
  editorMenuExplain: "EXPLAIN (実行計画)",
  editorMenuFormatAll: "SQL を整形",
  editorMenuFormatSelection: "選択範囲を整形",
  editorMenuToggleComment: "行コメントの切り替え",
  editorMenuCut: "切り取り",
  editorMenuCopy: "コピー",
  editorMenuSelectAll: "すべて選択",
  editorMenuNeedsSelection: "先にテキストを選択してください",
  cmdkRunQuery: "クエリを実行",
  cmdkExplainRun: "EXPLAIN を実行",
  cmdkRunSelected: "選択範囲 / カーソル位置の文を実行",
  cmdkExplainQuery: "実行計画を表示 (EXPLAIN)",
  cmdkFormatSql: "SQL を整形",
  cmdkFocusEditor: "SQL エディタへフォーカスを移す",
  cmdkToggleActivity: "アクティビティを開閉",
  cmdkSwitchConnection: "接続を切り替え: {name}",
  gridCopyAsCsv: "行を CSV としてコピー",
  gridCopyAsCsvRows: "{count} 行を CSV としてコピー",
  gridCopyAsJson: "行を JSON としてコピー",
  gridCopyAsJsonRows: "{count} 行を JSON としてコピー",
  resultViewJson: "JSON",
  resultExplain: "EXPLAIN",
  resultExplainTitle: "この結果を出したクエリの実行計画を EXPLAIN タブで開きます",
  resultJsonRows: "{rows} 行",
  resultJsonTruncated: "{total} 行のうち先頭 {shown} 行を表示",
  resultJsonCopy: "JSON をコピー",
  resultJsonCopyTitle: "表示中の行を JSON 配列としてコピーします (マスク中の列は伏せ字のまま)",
  resultJsonCopied: "{rows} 行を JSON としてコピーしました",
  resultJsonEmpty: "表示する行がありません",
};
