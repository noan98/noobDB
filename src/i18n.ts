...
const en = {
  ...
  editUndo: "Undo",
  editUndoTitle: "Undo the last pending edit (Ctrl+Z / Cmd+Z)",
  editRedo: "Redo",
  editRedoTitle: "Redo the last undone edit (Ctrl+Shift+Z / Cmd+Shift+Z)",
...
const ja: Dict = {
  ...
  editUndo: "元に戻す",
  editUndoTitle: "直前の保留編集を取り消します (Ctrl+Z / Cmd+Z)",
  editRedo: "やり直す",
  editRedoTitle: "取り消した編集をやり直します (Ctrl+Shift+Z / Cmd+Shift+Z)",
